...
LEGACY_TESTS_EXEMPT_FROM_IMPORT_BOUNDARIES = {
    ...
    "apps/safety/tests/test_generative_safety_narratives.py",
    "apps/designer/tests/test_amendment_ripple_analyzer.py",
    ...
    "apps/tickets/tests/test_rag_support_triage.py",
