...
def step_stage_and_report(dry_run: bool, auto_commit: bool) -> None:
    ...
    """
    print("\n" + "=" * 60)
    print("STEP 3 / 3 — Staging compliance docs (Bypassed)")
    print("=" * 60)
    print(
        "\nℹ  GxP compliance reports are now configured as ephemeral build artifacts."
    )
    print("   They are ignored by Git and will not be staged or committed.")
    print("   You can preview the generated local reports at:")
    for doc in GXP_DOCS:
        print(f"     - {doc}")
