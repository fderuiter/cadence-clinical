...
if sys.version_info < (3, 14):
    try:
        ...
        sys.stderr.write(
            ...
            "Please run: uv run python scripts/validate_adrs.py\n"
        )
        sys.exit(1)
...
def is_architectural_file(filepath: str) -> bool:
    ...
    if (
        ...
        or filepath.startswith("apps/web/")
        or filepath.startswith("apps/subject-portal/")
    ):
        return False
...
def main():
    print_runtime_info("validate_adrs.py")
