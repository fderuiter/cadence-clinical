...
_RAW_WHITELISTED_ROUTES = {
    ...
    ("post", "/api/v1/execution/anomalies/evaluate"),
    ("get", "/api/v1/execution/anomalies/candidates"),
    ("post", "/api/v1/execution/anomalies/candidates/{query_id}/adjudicate"),
    ("get", "/api/v1/execution/locks/status/{form_id}"),
    ("delete", "/api/v1/eisf/documents/{document_id}"),
    ("get", "/api/v1/designer/digitization/sample"),
    ("get", "/api/v1/econsent/archival-status"),
    ("get", "/api/v1/econsent/archival-status/{correlation_id}"),
    ("get", "/api/v1/econsent/clauses"),
    ("get", "/api/v1/econsent/clauses/{clause_id}"),
    ("get", "/api/v1/econsent/documents/{id}"),
    ("get", "/api/v1/econsent/subjects/{subject_pseudonym}/consent-status"),
    ("get", "/api/v1/econsent/templates"),
    ("get", "/api/v1/econsent/templates/{template_id}"),
    ("get", "/api/v1/econsent/templates/{template_id}/approved-content"),
    ("get", "/api/v1/econsent/templates/{template_id}/compose"),
    (
        "get",
        "/api/v1/econsent/templates/{template_id}/versions/{version_index}/comprehension-checks",
    ),
    ("get", "/api/v1/econsent/translations"),
    ("get", "/api/v1/econsent/translations/{translation_id}"),
    ("get", "/api/v1/eisf/binders/{site_id}"),
    ("get", "/api/v1/eisf/completeness"),
    ("get", "/api/v1/eisf/documents"),
    ("get", "/api/v1/eisf/documents/{document_id}"),
    ("get", "/api/v1/eisf/documents/{document_id}/download"),
    ("get", "/api/v1/eisf/sites/{site_id}/binder"),
    ("get", "/api/v1/eisf/sites/{site_id}/documents/{doc_id}"),
    ("get", "/api/v1/eisf/sites/{site_id}/documents/{doc_id}/download"),
    ("get", "/api/v1/execution/coding/queue"),
    ("get", "/api/v1/execution/labs/batch-status"),
    ("get", "/api/v1/execution/labs/batch-status/{batch_id}"),
    ("get", "/api/v1/execution/locks/tree"),
    ("get", "/api/v1/org/audit-logs"),
    ("get", "/api/v1/org/delegations"),
    ("get", "/api/v1/org/delegations/{id}"),
    ("get", "/api/v1/org/delegations/{id}/history"),
    ("get", "/api/v1/org/organizations"),
    ("get", "/api/v1/org/organizations/{id}"),
    ("get", "/api/v1/org/organizations/{id}/history"),
    ("get", "/api/v1/org/personnel"),
    ("get", "/api/v1/org/personnel/{id}"),
    ("get", "/api/v1/org/personnel/{id}/history"),
    ("get", "/api/v1/org/sites"),
    ("get", "/api/v1/org/sites/{id}"),
    ("get", "/api/v1/org/sites/{id}/history"),
    ("get", "/api/v1/org/training-logs"),
    ("get", "/api/v1/org/training-logs/{id}"),
    ("get", "/api/v1/org/training-logs/{id}/history"),
    ("post", "/api/v1/designer/digitization/extract"),
    ("post", "/api/v1/designer/studies/{study_id}/commit-usdm"),
    ("post", "/api/v1/econsent/clauses"),
    ("post", "/api/v1/econsent/documents"),
    ("post", "/api/v1/econsent/templates"),
    ("post", "/api/v1/econsent/templates/{template_id}/publish"),
    (
        "post",
    ...
    ("post", "/api/v1/econsent/templates/{template_id}/versions/{version_index}/sign"),
    (
        "post",
        "/api/v1/econsent/templates/{template_id}/versions/{version_index}/submit-answers",
    ),
    ("post", "/api/v1/econsent/translations"),
    ("post", "/api/v1/econsent/translations/{translation_id}/transition"),
    ("post", "/api/v1/eisf/documents"),
    ("post", "/api/v1/eisf/ingest"),
    ("post", "/api/v1/eisf/sites/{site_id}/documents/upload"),
    ("post", "/api/v1/eisf/sync"),
    ("post", "/api/v1/execution/exports/wizard"),
    ("post", "/api/v1/execution/labs/ingest"),
    ("post", "/api/v1/org/delegations"),
    ("post", "/api/v1/org/delegations/{id}/revoke"),
    ("post", "/api/v1/org/delegations/{id}/sign-off"),
    ("post", "/api/v1/org/organizations"),
    ("post", "/api/v1/org/personnel"),
    ("post", "/api/v1/org/sites"),
    ("post", "/api/v1/org/training-logs"),
    ("post", "/api/v1/org/training-logs/{id}/sign"),
    ("post", "/events/publish"),
    ("put", "/api/v1/econsent/clauses/{clause_id}"),
    ("put", "/api/v1/econsent/templates/{template_id}"),
    ("put", "/api/v1/econsent/translations/{translation_id}"),
    ("put", "/api/v1/eisf/documents/{document_id}"),
    ("put", "/api/v1/org/organizations/{id}"),
    ("put", "/api/v1/org/personnel/{id}"),
    ("put", "/api/v1/org/sites/{id}"),
    ("put", "/api/v1/org/training-logs/{id}"),
...
def test_api_request_bodies_parity(loaded_specs):
    ...
    for spec_path, path_item in spec_dict.get("paths", {}).items():
        ...
        for method, op in path_item.items():
            ...
            if method_lower in ["parameters", "summary", "description"]:
                continue
            if is_whitelisted(method_lower, spec_path):
                continue
