...
1. **State Persistence:** Added `last_escalated_at`, `last_escalation_notified_at`, and `escalation_count` to the `Ticket` model in `apps/tickets/models/`.
...
* **Affected Files:** `apps/tickets/models/`, `apps/tickets/escalation.py`, `apps/tickets/main.py`
* **Verification Plan:**
