...
Make these files completely deterministic, ensuring they _only_ change when functional changes (e.g., adding/removing secrets or test cases) actually occur.
