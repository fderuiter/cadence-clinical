...
- **Ledger Discovery:** The self-audit list log entry is written _before_ executing the paginated count and retrieval queries. This guarantees that the caller's own query event is immediately discoverable within the returned dataset.
