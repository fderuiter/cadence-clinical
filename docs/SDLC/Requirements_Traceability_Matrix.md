...
| PRD-QRY-007 | PRD | **Targeted SDV (tSDV) Sampling Algorithm** | `test_is_subject_selected_for_sdv` (tests/test_tsdv_logic.py) 🟢<br>`test_is_field_required` (tests/test_tsdv_logic.py) 🟢<br>`test_evaluate_tsdv_requirement_pure` (tests/test_tsdv_logic.py) 🟢<br>`test_tsdv_config_api_authorization_and_validation` (tests/test_tsdv_logic.py) 🟢<br>`test_tsdv_config_api_upsert_and_retrieval` (tests/test_tsdv_logic.py) 🟢<br>`test_tsdv_evaluation_endpoint` (tests/test_tsdv_logic.py) 🟢<br>`test_clinical_observation_sdv_defaults` (tests/test_sdv_tsdv_persistence.py) 🟢<br>`test_tsdv_config_persistence` (tests/test_sdv_tsdv_persistence.py) 🟢 | ✅ **Passed** |
