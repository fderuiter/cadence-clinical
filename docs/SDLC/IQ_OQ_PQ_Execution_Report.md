...
| :--- | :--- | :--- | :--- | :--- |
| `test_protocol_sign_off_archival_to_etmf` | `tests.test_protocol_sign_off` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_protocol_sign_off_requires_sig_token` | `tests.test_protocol_sign_off` | *Regression/Helper* | 🟢 PASSED | < 1s |
