...
- **Total Automated Test Cases Run:** 74
- **Passed:** 74 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| :--- | :--- | :--- | :--- | :--- |
| `test_batch_sign_off_audit_log_capture` | `tests.test_batch_sign_off` | PRD-SYS-001, PRD-SYS-002, Trace-1 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_form_lock_rejection` | `tests.test_batch_sign_off` | PRD-SYS-003, Trace-3 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_general_exception_rollback` | `tests.test_batch_sign_off` | PRD-SYS-002 | 🟢 PASSED | < 1s |
...
| `test_batch_sign_off_subject_lock_rejection` | `tests.test_batch_sign_off` | PRD-SYS-003, Trace-3 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_subject_resolution` | `tests.test_batch_sign_off` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_batch_sign_off_token_action_mismatch` | `tests.test_batch_sign_off` | PRD-SYS-001 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_token_expired` | `tests.test_batch_sign_off` | PRD-SYS-001 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_token_invalid_signature` | `tests.test_batch_sign_off` | PRD-SYS-001 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_token_replay` | `tests.test_batch_sign_off` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_batch_sign_off_token_user_mismatch` | `tests.test_batch_sign_off` | PRD-SYS-001 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_trial_lock_rejection` | `tests.test_batch_sign_off` | PRD-SYS-003, Trace-3 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_visit_lock_rejection` | `tests.test_batch_sign_off` | PRD-SYS-003, Trace-3 | 🟢 PASSED | < 1s |
