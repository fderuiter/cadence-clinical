...
| `test_load_whitelist_missing` | `tests.test_detect_duplication` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_load_whitelist_success` | `tests.test_detect_duplication` | *Regression/Helper* | 🟢 PASSED | < 1s |
...
| `test_main_with_mixed_duplicates` | `tests.test_detect_duplication` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_main_with_whitelisted_duplicates` | `tests.test_detect_duplication` | *Regression/Helper* | 🟢 PASSED | < 1s |
