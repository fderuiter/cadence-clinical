...
- **Total Automated Test Cases Run:** 1026
- **Passed:** 1026 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| `test_is_production_profile_detection` | `tests.test_dynamic_config_assertions` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_non_production_profile_allows_fallback_secrets` | `tests.test_dynamic_config_assertions` | PRD-CFG-003 | 🟢 PASSED | < 1s |
| `test_production_profile_fails_on_active_developer_bypass_flags` | `tests.test_dynamic_config_assertions` | PRD-CFG-002, PRD-CFG-004 | 🟢 PASSED | < 1s |
| `test_production_profile_fails_on_default_gateway_secret` | `tests.test_dynamic_config_assertions` | PRD-CFG-001 | 🟢 PASSED | < 1s |
| `test_production_profile_fails_on_weak_or_predictable_secret` | `tests.test_dynamic_config_assertions` | PRD-CFG-001 | 🟢 PASSED | < 1s |
| `test_production_profile_ignores_falsy_developer_bypass_flags` | `tests.test_dynamic_config_assertions` | PRD-CFG-002 | 🟢 PASSED | < 1s |
| `test_production_profile_requires_gateway_secret` | `tests.test_dynamic_config_assertions` | PRD-CFG-001 | 🟢 PASSED | < 1s |
| `test_production_profile_succeeds_on_strong_secret` | `tests.test_dynamic_config_assertions` | PRD-CFG-001, PRD-CFG-004 | 🟢 PASSED | < 1s |
