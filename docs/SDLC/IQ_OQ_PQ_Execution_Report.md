...
| `test_conflict_resolution_client_wins` | `tests.test_offline_e2e` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_conflict_resolution_merge` | `tests.test_offline_e2e` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_cryptographic_signature_verification` | `tests.test_offline_e2e` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_offline_persistence_across_reloads` | `tests.test_offline_e2e` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_offline_sync_trigger_on_online` | `tests.test_offline_e2e` | *Regression/Helper* | 🟢 PASSED | < 1s |
