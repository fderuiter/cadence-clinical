...
- **Total Automated Test Cases Run:** 2001
- **Passed:** 2001 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| `test_sdv_state_machine_allowed_transitions` | `tests.test_sdv_state_machine` | PRD-QRY-005 | 🟢 PASSED | < 1s |
| `test_sdv_state_machine_disallowed_transitions` | `tests.test_sdv_state_machine` | PRD-QRY-005 | 🟢 PASSED | < 1s |
| `test_sdv_state_machine_early_return` | `tests.test_sdv_state_machine` | PRD-QRY-005 | 🟢 PASSED | < 1s |
| `test_sdv_state_machine_enum_support` | `tests.test_sdv_state_machine` | PRD-QRY-005 | 🟢 PASSED | < 1s |
| `test_sdv_state_machine_normalization` | `tests.test_sdv_state_machine` | PRD-QRY-005 | 🟢 PASSED | < 1s |
| `test_sdv_state_machine_reason_requirements` | `tests.test_sdv_state_machine` | PRD-QRY-005 | 🟢 PASSED | < 1s |
| `test_sdv_state_machine_unsupported_statuses` | `tests.test_sdv_state_machine` | PRD-QRY-005 | 🟢 PASSED | < 1s |
