...
- **Total Automated Test Cases Run:** 2090
- **Passed:** 0 🟢
- **Unverified (Draft):** 2090 ⚪
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| :--- | :--- | :--- | :--- | :--- |
| `test_change_request_audit_trail_recorded` | `apps.compliance.tests.test_compliance_change_request` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_change_request_requires_dual_approval` | `apps.compliance.tests.test_compliance_change_request` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_compliance_change_request_audit_trail` | `apps.compliance.tests.test_compliance_change_request` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_assert_secure_secrets_validation` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_audit_logger_creates_valid_record` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_audit_logger_detects_chain_tampering` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_audit_logger_raises_runtime_error_if_secret_missing` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_crypto_verifier_invalid_signature` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_crypto_verifier_valid_signature` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gateway_raises_runtime_error_if_secret_missing` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_global_scanner_with_opt_out` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_security_audit_exclusions` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_security_audit_scanner_detection_and_bypass` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_security_audit_script` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_security_audit_targeted_files` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signing_raises_runtime_error_if_email_secret_missing` | `apps.compliance.tests.test_compliance_security` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_complete_doa_workflow_lifecycle` | `apps.ctms.tests.test_doa_workflow` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_compare_usdm_snapshots_added_removed_modified` | `apps.designer.tests.test_amendment_diff` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_backward_compatible_form_rehydration_lifecycle` | `apps.designer.tests.test_amendment_rehydration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_amendment_summary_endpoint` | `apps.designer.tests.test_amendment_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_publish_amendment_post_endpoint` | `apps.designer.tests.test_amendment_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_failure_recovery_high_availability` | `apps.designer.tests.test_crf_builder_compliance` | PRD-CRF-014, PRD-CRF-015, Trace-32, Trace-33 | ⚪ UNVERIFIED | N/A |
...
| `test_in_memory_accessibility_auditing` | `apps.designer.tests.test_crf_builder_compliance` | PRD-CRF-015, Trace-33 | ⚪ UNVERIFIED | N/A |
...
| `test_in_memory_accessibility_auditing` | `apps.designer.tests.test_crf_requirements_mapping` | PRD-CRF-015, Trace-31 | ⚪ UNVERIFIED | N/A |
...
| `test_python_evaluator_indexed_repeat_and_arity_mismatch` | `apps.designer.tests.test_designer_rules` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_arithmetic_null_safety_and_bmi` | `apps.designer.tests.test_evaluator` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cascading_dependent_nullification_parity` | `apps.designer.tests.test_evaluator` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_comparison_null_semantics` | `apps.designer.tests.test_evaluator` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_comparison_operators` | `apps.designer.tests.test_evaluator` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_field_reference_and_xpath` | `apps.designer.tests.test_evaluator` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_indexed_repeat` | `apps.designer.tests.test_evaluator` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_is_empty_and_not_empty` | `apps.designer.tests.test_evaluator` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_literal_and_constant` | `apps.designer.tests.test_evaluator` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_granular_locking_end_to_end_audit_flow` | `apps.designer.tests.test_granular_locking` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_absent_and_malformed_roles` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_allowed_roles_matrix` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_forbidden_roles_matrix` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_form_lock_and_unlock_lifecycle` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gateway_bypass_prevention` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lock_status_retrieval` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_locked_write_prevention` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_roles_authorization_restrictions` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_lock_and_unlock_lifecycle` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_subject_lock_and_unlock_lifecycle` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_trial_lock_and_unlock_lifecycle` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_visit_lock_and_unlock_lifecycle` | `apps.designer.tests.test_granular_locks_api` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_lock_enforcement_field_level_blocked` | `apps.designer.tests.test_lock_enforcement` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lock_enforcement_form_level_blocked` | `apps.designer.tests.test_lock_enforcement` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_data_lock_record_creation` | `apps.designer.tests.test_lock_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_data_unlock_record_creation` | `apps.designer.tests.test_lock_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_form_lock_status_endpoint` | `apps.designer.tests.test_lock_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lock_data_missing_reason_returns_400` | `apps.designer.tests.test_lock_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lock_data_post_endpoint` | `apps.designer.tests.test_lock_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unlock_data_post_endpoint` | `apps.designer.tests.test_lock_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_clinical_capture_provenance_and_version_stamping` | `apps.designer.tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_etmf_document_change_rationale_mandatory_rules` | `apps.designer.tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_etmf_linkage_and_version_history_lineage` | `apps.designer.tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_etmf_qc_transitions_immutability` | `apps.designer.tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_exact_version_consent_and_reconsent_gating` | `apps.designer.tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_non_destructive_reconciliation_and_multi_hop` | `apps.designer.tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_site_and_visit_locks` | `apps.designer.tests.test_trial_lock` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_subject_and_form_locks` | `apps.designer.tests.test_trial_lock` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_trial_lock_freeze` | `apps.designer.tests.test_trial_lock` | PRD-SYS-003, Trace-3 | ⚪ UNVERIFIED | N/A |
...
| `test_subject_consent_blocking_and_reconsent_lifecycle` | `apps.econsent.tests.test_reconsent_blocking` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_subject_consent_endpoint_lifecycle` | `apps.econsent.tests.test_reconsent_blocking` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_exception_route` | `apps.etmf.main` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_adam_dataset_export_success` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_biostat_bundle_export_success` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_export_validation_failure_handling` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_invalid_adam_dataset_rejection` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_invalid_sdtm_domain_rejection` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdtm_domain_export_success` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unauthenticated_access_rejection` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_cache_purge_expired` | `apps.execution.tests.test_cdisc_cache` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_cache_save_and_get` | `apps.execution.tests.test_cdisc_cache` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_cache_ttl_expiration` | `apps.execution.tests.test_cdisc_cache` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_cdisc_library_client_get_cdash_domain_fallback` | `apps.execution.tests.test_cdisc_library_client` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_library_client_get_codelist_fallback` | `apps.execution.tests.test_cdisc_library_client` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_library_client_get_sdtm_domain_fallback` | `apps.execution.tests.test_cdisc_library_client` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_library_client_local_fallback_products` | `apps.execution.tests.test_cdisc_library_client` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_library_client_mock_api_key_auth` | `apps.execution.tests.test_cdisc_library_client` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_library_config_defaults` | `apps.execution.tests.test_cdisc_library_client` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_openapi_component_schemas` | `apps.execution.tests.test_cdisc_openapi_contract` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_openapi_export_parity` | `apps.execution.tests.test_cdisc_openapi_contract` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_openapi_file_exists_and_valid` | `apps.execution.tests.test_cdisc_openapi_contract` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_openapi_paths_coverage` | `apps.execution.tests.test_cdisc_openapi_contract` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_accept_timezone_aware_inputs` | `apps.execution.tests.test_datetime_validation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_no_silent_fallback_to_system_time` | `apps.execution.tests.test_datetime_validation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pydantic_defaults_are_timezone_aware` | `apps.execution.tests.test_datetime_validation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reject_timezone_naive_datetime_objects` | `apps.execution.tests.test_datetime_validation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reject_timezone_naive_strings` | `apps.execution.tests.test_datetime_validation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_serialized_clinical_outputs_trailing_z` | `apps.execution.tests.test_datetime_validation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_signature_verification_keycloak_token_secret` | `apps.execution.tests.test_double_auth` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_replay_attack_prevention` | `apps.execution.tests.test_double_auth` | PRD-QRY-005 | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_role_insufficient_auth` | `apps.execution.tests.test_double_auth` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_token_expiration` | `apps.execution.tests.test_double_auth` | PRD-QRY-005 | ⚪ UNVERIFIED | N/A |
...
| `test_api_v2_export_default` | `apps.execution.tests.test_full_usdm_v2_phase_2` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_v2_export_invalid_format` | `apps.execution.tests.test_full_usdm_v2_phase_2` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_v2_export_json_and_yaml` | `apps.execution.tests.test_full_usdm_v2_phase_2` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_v2_import_missing_change_reason` | `apps.execution.tests.test_full_usdm_v2_phase_2` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_v2_import_valid_yaml` | `apps.execution.tests.test_full_usdm_v2_phase_2` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_v2_import_validation_failure` | `apps.execution.tests.test_full_usdm_v2_phase_2` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gateway_proxying_v2_studies` | `apps.execution.tests.test_full_usdm_v2_phase_2` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_circular_skip_logic_rules_raises_value_error` | `apps.execution.tests.test_inverse_mapper` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_inverse_mapping_valid_round_trip` | `apps.execution.tests.test_inverse_mapper` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_missing_required_fields_raises_value_error` | `apps.execution.tests.test_inverse_mapper` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_resolve_concept_id` | `apps.execution.tests.test_inverse_mapper` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unmapped_fields_preservation` | `apps.execution.tests.test_inverse_mapper` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unsupported_rule_expression_raises_value_error` | `apps.execution.tests.test_inverse_mapper` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_duplicate_certificate_injection_rejected` | `apps.execution.tests.test_part11_compliance_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_legacy_padding_pkcs1v15_fails` | `apps.execution.tests.test_part11_compliance_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_mandatory_documents_bypass_rejected` | `apps.execution.tests.test_part11_compliance_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_mock_signatures_blocked` | `apps.execution.tests.test_part11_compliance_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_rsassa_pss_succeeds` | `apps.execution.tests.test_part11_compliance_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unapproved_self_signed_certificate_fails` | `apps.execution.tests.test_part11_compliance_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_driver_session_transaction_wrappers` | `apps.execution.tests.test_query_safety_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_parameter_bypass_validation` | `apps.execution.tests.test_query_safety_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unbounded_wildcards_validation` | `apps.execution.tests.test_query_safety_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_activity_assignment_request` | `apps.execution.tests.test_shared_soa_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_epoch_validation` | `apps.execution.tests.test_shared_soa_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_procedure_validation` | `apps.execution.tests.test_shared_soa_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_properties_payload_contracts` | `apps.execution.tests.test_shared_soa_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_study_arm_validation` | `apps.execution.tests.test_shared_soa_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_timing_window_validation` | `apps.execution.tests.test_shared_soa_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_visit_reorder_request` | `apps.execution.tests.test_shared_soa_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_visit_validation` | `apps.execution.tests.test_shared_soa_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_batch_signature_empty_target_forms_returns_400` | `apps.execution.tests.test_signature_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_signature_missing_password_returns_400` | `apps.execution.tests.test_signature_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_signature_sign_off_success` | `apps.execution.tests.test_signature_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_audit_reason_enforcement` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_concurrent_locking_conflict_exception_translation` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_invalid_signature_exception_translation` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_rule_soft_delete` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_soa_crud_lifecycle_endpoints` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_soa_immutability_guards` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_soa_immutability_guards_updates` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_soa_linking_and_matrix_projection` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_soa_retirement_and_projection_exclusion` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_soa_typed_validation_and_timing_rejection` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_unauthorized_requests` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_validation_failures` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_with_mocked_neo4j_driver` | `apps.execution.tests.test_soa_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_assert_study_version_mutable` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_epoch_neo4j` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_form_neo4j` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_soa_matrix_projection_neo4j` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_links_neo4j` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_mock_soa_entity_lifecycle` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_mutability_guard_rejects_locked_versions` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_neo4j_driver_operations` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_procedure_neo4j` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_soa_domain_models_schema_alignment` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_timing_window_neo4j` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_timing_window_persistence_and_carry_forward_mock` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_timing_window_update_carry_forward_neo4j` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_timing_window_validation_rules` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_update_study_arm_neo4j` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_visit_neo4j` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_with_transaction_retry_failure_exceeded` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_with_transaction_retry_success_after_retries` | `apps.execution.tests.test_soa_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_api_protocol_amendment_concurrency_race` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_protocol_amendment_invalid_signature_rejected` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_protocol_amendment_invalid_study_404` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_protocol_amendment_minor_and_major_bumps` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_protocol_approval_and_immutability` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_study_version_creation_and_guards` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_assert_graph_mutable_library_object_permits_active` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_assert_graph_mutable_library_object_rejects_frozen` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_assert_graph_mutable_permits_draft_active` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_assert_graph_mutable_rejects_frozen_states` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_bump_version_edge_cases` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_create_library_object_version_guards` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_mock_study_version_creation_and_immutability` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_neo4j_create_study_version_duplicate_raises_conflict` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_neo4j_create_study_version_success` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_update_study_properties_guards` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_verify_version_signature_edge_cases` | `apps.execution.tests.test_study_versions` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_terminology_cache_capacity_eviction` | `apps.execution.tests.test_terminology_cache` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_terminology_cache_hit_and_expiration` | `apps.execution.tests.test_terminology_cache` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_terminology_cache_thread_safety` | `apps.execution.tests.test_terminology_cache` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_terminology_cache_ttl_config` | `apps.execution.tests.test_terminology_cache` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_terminology_cache_unreachable_db_fallback` | `apps.execution.tests.test_terminology_cache` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cache_hit_performs_no_external_lookup` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_existing_cache_consumers_receive_expected_shape` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_expired_entry_fallback_on_unreachable_evs` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_terminology_from_db_delegation` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_terminology_from_db_nci_evs_offline_fallback` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_terminology_from_db_not_found_anywhere` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_terminology_from_db_not_found_in_evs_but_in_mock` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_terminology_from_db_transport_error_and_not_in_mock` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_terminology_from_db_transport_error_but_in_mock` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_offline_fallback_resolves_supported_seed_concepts` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_terminology_cache_unreachable_database_exception_fallback` | `apps.execution.tests.test_terminology_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_usdm_importer_invalid_payload_raises` | `apps.execution.tests.test_usdm_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_importer_valid_dict` | `apps.execution.tests.test_usdm_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_importer_valid_model` | `apps.execution.tests.test_usdm_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_importer_warning_empty_designs` | `apps.execution.tests.test_usdm_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_validate_usdm_endpoint_invalid_422` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_validate_usdm_endpoint_valid` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_normalize_usdm_payload_v2_to_v3` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_resolve_usdm_version_override` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_resolve_usdm_version_v2` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_resolve_usdm_version_v3` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_safe_parse_payload_invalid` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_safe_parse_payload_json` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_safe_parse_payload_yaml` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validate_usdm_payload_circular_skip_logic` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validate_usdm_payload_duplicate_ids` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validate_usdm_payload_invalid_structure` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validate_usdm_payload_stochastic_math_operators` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validate_usdm_payload_valid_v3` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validate_usdm_payload_warnings_custom_elements` | `apps.execution.tests.test_usdm_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_study_dump_by_alias` | `apps.execution.tests.test_usdm_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_study_parsing` | `apps.execution.tests.test_usdm_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_v2_to_v3_upgrade_transformer` | `apps.execution.tests.test_usdm_roundtrip` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_v3_lossless_roundtrip_fidelity` | `apps.execution.tests.test_usdm_roundtrip` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_round_trip_canonical_serialization_verification` | `apps.execution.tests.test_usdm_serialization` | PRD-MDR-007 | ⚪ UNVERIFIED | N/A |
| `test_serialize_usdm_canonical_json` | `apps.execution.tests.test_usdm_serialization` | PRD-MDR-007 | ⚪ UNVERIFIED | N/A |
| `test_serialize_usdm_canonical_yaml` | `apps.execution.tests.test_usdm_serialization` | PRD-MDR-007 | ⚪ UNVERIFIED | N/A |
| `test_serialize_usdm_validation_errors` | `apps.execution.tests.test_usdm_serialization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_transition_capa_sig_token_matrix` | `apps.quality.tests.test_quality_workflow` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_escalation_eligibility_rules` | `apps.tickets.tests.test_tickets_escalation` | Trace-16 | ⚪ UNVERIFIED | N/A |
...
| `test_api_routers_have_no_direct_db_imports` | `packages.hexagonal.tests.test_hexagonal_architecture` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ctms_application_isolation` | `packages.hexagonal.tests.test_hexagonal_architecture` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ctms_domain_isolation` | `packages.hexagonal.tests.test_hexagonal_architecture` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_designer_core_isolation` | `packages.hexagonal.tests.test_hexagonal_architecture` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_execution_application_isolation` | `packages.hexagonal.tests.test_hexagonal_architecture` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_execution_domain_isolation` | `packages.hexagonal.tests.test_hexagonal_architecture` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_is_logical_code` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_merge_generic_json` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_merge_markdown_text` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_merge_secrets_baseline` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
