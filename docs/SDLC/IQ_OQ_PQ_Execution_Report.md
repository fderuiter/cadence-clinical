...
- **Total Automated Test Cases Run:** 1764
- **Passed:** 1764 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| `test_gateway_base_client_request_sync_success` | `tests.test_gateway_base_client` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_gateway_base_client_retries_on_5xx` | `tests.test_gateway_base_client` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_gateway_base_client_retries_on_timeout` | `tests.test_gateway_base_client` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_gateway_base_client_signature_regenerated_on_retry` | `tests.test_gateway_base_client` | *Regression/Helper* | 🟢 PASSED | < 1s |
