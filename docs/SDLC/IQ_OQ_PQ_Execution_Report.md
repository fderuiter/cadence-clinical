...
| `test_layout_validation_integration` | `tests.test_layout_validator` | PRD-CRF-013, PRD-CRF-014, PRD-CRF-015, Trace-29, Trace-30, Trace-31 | 🟢 PASSED | < 1s |
| `test_layout_validation_invisible` | `tests.test_layout_validator` | PRD-CRF-010, PRD-CRF-011, PRD-CRF-012, Trace-26, Trace-27, Trace-28 | 🟢 PASSED | < 1s |
| `test_layout_validation_overlap` | `tests.test_layout_validator` | PRD-CRF-004, PRD-CRF-005, PRD-CRF-006, Trace-20, Trace-21, Trace-22 | 🟢 PASSED | < 1s |
| `test_layout_validation_scrambled_sequence` | `tests.test_layout_validator` | PRD-CRF-007, PRD-CRF-008, PRD-CRF-009, Trace-23, Trace-24, Trace-25 | 🟢 PASSED | < 1s |
| `test_layout_validation_valid` | `tests.test_layout_validator` | PRD-CRF-001, PRD-CRF-002, PRD-CRF-003, Trace-17, Trace-18, Trace-19 | 🟢 PASSED | < 1s |
