...
- **Total Automated Test Cases Run:** 2054
- **Passed:** 2054 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| `test_security_audit_scanner_multiline_and_mixedcase_bypass` | `tests.test_compliance_security` | *Regression/Helper* | 🟢 PASSED | < 1s |
