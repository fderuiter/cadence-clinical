...
| `test_soa_rbac_permissions` | `tests.test_designer_rbac` | *Regression/Helper* | 🟢 PASSED | < 1s |
...
| `test_soa_granular_permissions` | `tests.test_rbac_permissions` | *Regression/Helper* | 🟢 PASSED | < 1s |
