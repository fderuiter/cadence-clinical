...
- **Total Automated Test Cases Run:** 1681
- **Passed:** 1681 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| `test_outbound_transmission_adapter_with_client` | `tests.test_safety_adapter` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_prepare_and_deidentify_icsr` | `tests.test_safety_adapter` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_pseudonymize_value_pattern` | `tests.test_safety_adapter` | *Regression/Helper* | 🟢 PASSED | < 1s |
