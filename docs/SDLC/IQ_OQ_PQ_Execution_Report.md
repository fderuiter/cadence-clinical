...
- **Total Automated Test Cases Run:** 68
- **Passed:** 68 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| :--- | :--- | :--- | :--- | :--- |
| `test_batch_sign_off_all_lock_scopes_and_rollback` | `tests.test_batch_sign_off` | PRD-SYS-003, Trace-3 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_audit_log_capture` | `tests.test_batch_sign_off` | PRD-SYS-001 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_happy_path_form` | `tests.test_batch_sign_off` | PRD-SYS-001 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_locks_and_atomic_rollback` | `tests.test_batch_sign_off` | PRD-SYS-003 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_pi_only` | `tests.test_batch_sign_off` | PRD-SYS-003 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_subject_resolution` | `tests.test_batch_sign_off` | PRD-SYS-001 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_token_binding_mismatches` | `tests.test_batch_sign_off` | PRD-SYS-003 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_token_replay` | `tests.test_batch_sign_off` | PRD-SYS-003 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_unexpected_db_failure_rollback` | `tests.test_batch_sign_off` | PRD-SYS-003 | 🟢 PASSED | < 1s |
| `test_batch_sign_off_visit_resolution` | `tests.test_batch_sign_off` | PRD-SYS-001 | 🟢 PASSED | < 1s |
