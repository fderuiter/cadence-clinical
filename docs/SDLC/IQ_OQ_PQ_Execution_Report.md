...
- **Failed/Errors:** 679 🔴
- **Skipped:** 0 ⚪
- **Overall Operational Pass Rate:** 58.29%
...
| `test_audit_records_ip_and_custom_timestamp` | `tests.test_audit` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_hard_delete_is_prevented` | `tests.test_audit` | Trace-1 | 🔴 FAILED | < 1s |
| `test_insert_generates_audit_log` | `tests.test_audit` | PRD-SYS-001 | 🔴 FAILED | < 1s |
| `test_read_only_queries_do_not_generate_audit_logs` | `tests.test_audit` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_rollback_prevents_orphan_audit_logs` | `tests.test_audit` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_soft_delete_generates_audit_log` | `tests.test_audit` | PRD-SYS-002 | 🔴 FAILED | < 1s |
| `test_subject_notification_skips_clinical_auditing` | `tests.test_audit` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_update_generates_audit_log` | `tests.test_audit` | PRD-SYS-001 | 🔴 FAILED | < 1s |
...
| `test_batch_sign_off_all_locks` | `tests.test_batch_sign_off` | Trace-14 | 🔴 FAILED | < 1s |
| `test_batch_sign_off_audit_manifestation_capture` | `tests.test_batch_sign_off` | Trace-14 | 🔴 FAILED | < 1s |
| `test_batch_sign_off_happy_path_form` | `tests.test_batch_sign_off` | Trace-14, Trace-15 | 🔴 FAILED | < 1s |
| `test_batch_sign_off_locks_and_atomic_rollback` | `tests.test_batch_sign_off` | Trace-14 | 🔴 FAILED | < 1s |
| `test_batch_sign_off_mismatched_bindings_and_no_write` | `tests.test_batch_sign_off` | Trace-14, Trace-15 | 🔴 FAILED | < 1s |
| `test_batch_sign_off_non_lock_rollback` | `tests.test_batch_sign_off` | Trace-14 | 🔴 FAILED | < 1s |
| `test_batch_sign_off_pi_only` | `tests.test_batch_sign_off` | Trace-14 | 🔴 FAILED | < 1s |
| `test_batch_sign_off_subject_resolution` | `tests.test_batch_sign_off` | Trace-14 | 🔴 FAILED | < 1s |
| `test_batch_sign_off_token_replay` | `tests.test_batch_sign_off` | Trace-15 | 🔴 FAILED | < 1s |
| `test_batch_sign_off_visit_resolution` | `tests.test_batch_sign_off` | Trace-14 | 🔴 FAILED | < 1s |
...
| `test_age_capping_thresholds` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_authorization_allowed_role_succeeds` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_authorization_disallowed_role_receives_403` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_dataset_json_validation_passes_after_transform` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_date_shift_stable_and_interval_preserving` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_error_redaction_and_scrubbing_on_failed_export` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_identical_pseudonymization_across_datasets_and_supp` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_partial_dates_shifted_without_fabricating_precision` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_pseudonymization_determinism_and_hex_format` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_scrub_error_message_direct` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_source_records_are_not_mutated` | `tests.test_biostat_deidentification` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_adae_trtemfl_logic` | `tests.test_biostat_export` | ADAM-ADAE-TRTEMFL-01 | 🔴 FAILED | < 1s |
| `test_advs_chg_pchg_computations` | `tests.test_biostat_export` | ADAM-ADVS-CHG-01 | 🔴 FAILED | < 1s |
| `test_api_adam_export_success` | `tests.test_biostat_export` | API-ADAM-EXPORT-01 | 🔴 FAILED | < 1s |
| `test_api_biostat_bundle_export_with_supp_records` | `tests.test_biostat_export` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_api_sdtm_export_success` | `tests.test_biostat_export` | API-SDTM-EXPORT-01 | 🔴 FAILED | < 1s |
| `test_api_sdtm_export_with_supp_records` | `tests.test_biostat_export` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_api_unauthenticated_export_rejection` | `tests.test_biostat_export` | SEC-EXPORT-AUTH-01 | 🔴 FAILED | < 1s |
| `test_api_validation_failure_logging` | `tests.test_biostat_export` | API-EXPORT-VAL-01 | 🔴 FAILED | < 1s |
| `test_partial_date_imputation_detailed` | `tests.test_biostat_export` | SDTM-IMPUTE-01 | 🔴 FAILED | < 1s |
| `test_sdtm_age_derivation` | `tests.test_biostat_export` | SDTM-DM-AGE-01 | 🔴 FAILED | < 1s |
| `test_sdtm_sequence_assignment` | `tests.test_biostat_export` | SDTM-SEQ-01 | 🔴 FAILED | < 1s |
| `test_sdtm_supplemental_qualifiers` | `tests.test_biostat_export` | SDTM-SUPP-01 | 🔴 FAILED | < 1s |
| `test_adam_dataset_export_success` | `tests.test_biostat_exports` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_biostat_bundle_export_success` | `tests.test_biostat_exports` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_export_validation_failure_handling` | `tests.test_biostat_exports` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_invalid_adam_dataset_rejection` | `tests.test_biostat_exports` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_invalid_sdtm_domain_rejection` | `tests.test_biostat_exports` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_sdtm_domain_export_success` | `tests.test_biostat_exports` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unauthenticated_access_rejection` | `tests.test_biostat_exports` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_rtm_generation_conftest_hook_detection` | `tests.test_cli_etmf_archival` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_rtm_generation_with_cli_overrides` | `tests.test_cli_etmf_archival` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_api_gateway_routing` | `tests.test_clinical_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cdisc_export_and_validation` | `tests.test_clinical_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_demographics_encryption` | `tests.test_clinical_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_outlier_detection_performance` | `tests.test_clinical_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_relational_persistence_and_recalculation` | `tests.test_clinical_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unit_conversions` | `tests.test_clinical_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_candidate_creation_and_opening_workflow` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_clinical_queries_sync_endpoint` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_clinical_query_creation_with_all_audited_fields` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_clinical_query_trial_lock_enforcement_at_visit_level` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_create_clinical_query_authorization_failures` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_create_clinical_query_success` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_database_events_prevent_deletions` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_duplicate_active_query_rejected` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_query_role_gates_robustness` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_query_state_transition_and_role_boundaries` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_rejection_and_cancellation_reason_requirements` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_reopen_transitions` | `tests.test_clinical_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_publish_notification_failure_swallowed` | `tests.test_clinical_workflow_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_publish_notification_success` | `tests.test_clinical_workflow_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_router_send_dashboard_notification_sdv_drop` | `tests.test_clinical_workflow_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_router_send_email_mapping` | `tests.test_clinical_workflow_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_router_send_sms_mapping` | `tests.test_clinical_workflow_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_router_send_webhook_mapping` | `tests.test_clinical_workflow_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unblind_emergency_unblinding_alert_integration` | `tests.test_clinical_workflow_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_emergency_unblinding_generates_notification` | `tests.test_clinical_workflow_notifications_integration` | PRD-SUB-006 | 🔴 FAILED | < 1s |
| `test_query_aging_generates_notification` | `tests.test_clinical_workflow_notifications_integration` | PRD-QRY-002 | 🔴 FAILED | < 1s |
| `test_sdv_drop_generates_notification` | `tests.test_clinical_workflow_notifications_integration` | PRD-QRY-006 | 🔴 FAILED | < 1s |
| `test_trial_lock_generates_notification` | `tests.test_clinical_workflow_notifications_integration` | PRD-SYS-003, PRD-SYS-004 | 🔴 FAILED | < 1s |
...
| `test_cra_allocations_rbac_reassignment_workload` | `tests.test_ctms` | PRD-CTMS-003, Trace-6 | 🔴 FAILED | < 1s |
| `test_create_and_list_studies_rbac` | `tests.test_ctms` | PRD-CTMS-004, Trace-6 | 🔴 FAILED | < 1s |
| `test_ctms_health_check` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_ctms_sync_conflict_merge` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_ctms_sync_conflict_server_wins` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_ctms_sync_happy_path_and_reloads` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_ctms_sync_rbac_denial` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_ctms_sync_structural_conflict` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_database_manager_uninitialized` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_get_audit_trail_rbac` | `tests.test_ctms` | PRD-CTMS-004, Trace-6 | 🔴 FAILED | < 1s |
| `test_grant_approve_sig_token_matrix` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_grant_creation_rbac` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_grant_locked_when_approved` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_milestone_trigger_manual` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_milestone_trigger_study_approved` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_milestone_trigger_visit_completed_automated` | `tests.test_ctms` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_monitoring_visit_invalid_state_and_findings` | `tests.test_ctms` | PRD-CTMS-002, Trace-6 | 🔴 FAILED | < 1s |
| `test_monitoring_visit_scheduling_respects_cra_allocation` | `tests.test_ctms` | PRD-CTMS-003, Trace-6 | 🔴 FAILED | < 1s |
| `test_monitoring_visit_workflow_happy_path` | `tests.test_ctms` | PRD-CTMS-002, Trace-6 | 🔴 FAILED | < 1s |
| `test_monitoring_visit_workflow_rbac_denials` | `tests.test_ctms` | PRD-CTMS-002, Trace-6 | 🔴 FAILED | < 1s |
| `test_recruitment_records_crud_and_audit` | `tests.test_ctms` | PRD-CTMS-004, Trace-6 | 🔴 FAILED | < 1s |
| `test_site_milestones_crud_and_audit` | `tests.test_ctms` | PRD-CTMS-001, Trace-6 | 🔴 FAILED | < 1s |
...
| `test_complete_doa_workflow_lifecycle` | `tests.test_doa_workflow` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_document_renderer_render_docx` | `tests.test_document_renderer` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_document_renderer_render_pdf` | `tests.test_document_renderer` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_parse_e2b_xml_valid_payload` | `tests.test_e2b_parser` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_assignment_compliance_states_and_recalculations` | `tests.test_ecoa_coverage` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_instrument_retrieval_and_assignment_boundaries` | `tests.test_ecoa_coverage` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_notifications_lifecycle_reminders_and_acknowledgments` | `tests.test_ecoa_coverage` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_offline_submission_conflict_resolution_lifecycles` | `tests.test_ecoa_coverage` | PRD-EDC-008 | 🔴 FAILED | < 1s |
| `test_structural_conflict_on_missing_or_deleted_targets` | `tests.test_ecoa_coverage` | PRD-EDC-008 | 🔴 FAILED | < 1s |
| `test_subject_only_authorization_and_cross_subject_rejection` | `tests.test_ecoa_coverage` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_authoring_mutations_rejected_for_auditors` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_clause_lifecycle_and_versioning_audit` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_database_url_override_and_init` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_econsent_database_schema_creation` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_econsent_document_lifecycle_and_audit_context` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_econsent_get_not_found` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_econsent_health_check` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_econsent_pydantic_schemas` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_gateway_auth_middleware_denials` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_shared_audit_fields_validation` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_template_lifecycle_and_validation` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_uninitialized_database_manager_econsent` | `tests.test_econsent` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_archival_status_endpoints` | `tests.test_econsent_archival` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_icf_sign_and_archival_queueing` | `tests.test_econsent_archival` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_poll_and_dispatch_failure_and_retry_backoff` | `tests.test_econsent_archival` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_poll_and_dispatch_success` | `tests.test_econsent_archival` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_append_only_audit_history` | `tests.test_econsent_capture` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_capture_rejections` | `tests.test_econsent_capture` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_execution_consumption_integration` | `tests.test_econsent_capture` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_happy_path_capture_and_status` | `tests.test_econsent_capture` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_signature_tamper_detection` | `tests.test_econsent_capture` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_auditor_restrictions_on_checks` | `tests.test_econsent_comprehension` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_create_and_retrieve_comprehension_check` | `tests.test_econsent_comprehension` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_signature_blocks_if_comprehension_checks_fail_or_incomplete` | `tests.test_econsent_comprehension` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_submit_answers_and_evaluation_boundaries` | `tests.test_econsent_comprehension` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_template_version_separation` | `tests.test_econsent_comprehension` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_approved_content_retrieval_and_cache` | `tests.test_econsent_translations` | Trace-10 | 🔴 FAILED | < 1s |
| `test_language_code_validation` | `tests.test_econsent_translations` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_translation_crud_and_validation` | `tests.test_econsent_translations` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_translation_status_workflow_and_rbac` | `tests.test_econsent_translations` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_authored_cross_form_rule_lifecycle` | `tests.test_edit_checks` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_authored_longitudinal_predecessor_handling` | `tests.test_edit_checks` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cross_form_temporal_consistency_and_context_propagation` | `tests.test_edit_checks` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_deferred_predecessor_checks` | `tests.test_edit_checks` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_same_record_failure_outlier_and_auto_close` | `tests.test_edit_checks` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_scenario_cross_form_edit_checks_and_auto_resolve` | `tests.test_edit_checks_scenarios` | PRD-QRY-003 | 🔴 FAILED | < 1s |
| `test_scenario_longitudinal_predecessor_draft_and_complete` | `tests.test_edit_checks_scenarios` | PRD-QRY-004 | 🔴 FAILED | < 1s |
| `test_scenario_skip_logic_and_cascading_nullification` | `tests.test_edit_checks_scenarios` | PRD-EDC-003, PRD-EDC-004 | 🔴 FAILED | < 1s |
...
| `test_eisf_auditor_write_forbidden` | `tests.test_eisf_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_document_cross_site_rejection_and_audit` | `tests.test_eisf_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_document_lifecycle_same_site` | `tests.test_eisf_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_documents_endpoint_blocks_unauthenticated` | `tests.test_eisf_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_health_unauthenticated` | `tests.test_eisf_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_auditor_view_and_download_permissions` | `tests.test_eisf_browse_completeness` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_completeness_workflow` | `tests.test_eisf_browse_completeness` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_document_listing_with_binder_filters` | `tests.test_eisf_browse_completeness` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_document_view_and_download_site_isolation` | `tests.test_eisf_browse_completeness` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_ingest_document_event_alias` | `tests.test_eisf_ingest` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_ingest_document_success` | `tests.test_eisf_ingest` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_ingest_missing_change_reason_fails` | `tests.test_eisf_ingest` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_site_isolation_lifecycle` | `tests.test_eisf_isolation` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_eisf_document_record_creation` | `tests.test_eisf_models` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_database_url_override_and_init` | `tests.test_eisf_persistence` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_append_only_versions_and_deduplication` | `tests.test_eisf_persistence` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_document_creation_and_site_scoped` | `tests.test_eisf_persistence` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_part11_audit_log_retention` | `tests.test_eisf_persistence` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_uninitialized_database_manager_eisf` | `tests.test_eisf_persistence` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_eisf_upload_and_watermark` | `tests.test_eisf_service` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_eisf_completeness_site_isolation` | `tests.test_eisf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_external_monitor_role` | `tests.test_eisf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_site_scoped_users_read_isolation` | `tests.test_eisf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_site_scoped_write_restrictions` | `tests.test_eisf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sponsor_admin_global_visibility` | `tests.test_eisf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_conflict_client_wins` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_conflict_merge_lexicographic_tiebreaker` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_conflict_merge_lww_existing_wins` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_conflict_merge_lww_incoming_wins` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_conflict_server_wins` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_creation_and_etmf_propagation` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_echo_loop_prevention` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_exact_duplicate_ignored` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_per_field_metadata_lww` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_sync_unmapped_propagation` | `tests.test_eisf_sync` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_unblind_missing_sig_token` | `tests.test_emergency_unblinding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unblind_screening_status_error` | `tests.test_emergency_unblinding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unblind_subject_not_found` | `tests.test_emergency_unblinding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unblind_success_authorized_access` | `tests.test_emergency_unblinding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unblind_success_masked_access` | `tests.test_emergency_unblinding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unblind_withdrawn_status_error` | `tests.test_emergency_unblinding` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_archived_document_retrieval_and_immutability` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_automated_ingestion_and_version_indexing` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_canonical_catalog_ingestion_validations` | `tests.test_etmf` | PRD-TMF-002, PRD-TMF-003, Trace-5 | 🔴 FAILED | < 1s |
| `test_completeness_checking_transitions` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_completeness_from_catalog` | `tests.test_etmf` | PRD-TMF-004 | 🔴 FAILED | < 1s |
| `test_completeness_from_catalog_across_versions` | `tests.test_etmf` | PRD-TMF-004 | 🔴 FAILED | < 1s |
| `test_deterministic_and_complete_binder_export` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_edl_definitions_and_crud` | `tests.test_etmf` | PRD-EDL-001, Trace-4 | 🔴 FAILED | < 1s |
| `test_etmf_audit_logs_filtering_and_pagination` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_edge_cases_for_coverage` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_qc_lifecycle_and_audit` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_explicit_and_default_taxonomy_version_roundtrip_and_legacy_interpretability` | `tests.test_etmf` | PRD-TMF-003 | 🔴 FAILED | < 1s |
| `test_informed_consent_form_taxonomy_and_idempotency` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_inspector_portal_read_only_access_limits` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_ordered_artifact_history_endpoint` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_placeholder_scripts` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_protocol_versioning_and_change_justification_ingestion` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_qualify_catalog_cutover_and_extension_persistence` | `tests.test_etmf` | PRD-TMF-002, Trace-5 | 🔴 FAILED | < 1s |
| `test_regulatory_binder_export` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_service_caller_ingestion_immutability_violation` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_service_caller_ingestion_rollback_on_failure` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_service_caller_ingestion_success` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_aware_completeness` | `tests.test_etmf` | PRD-EDL-001, Trace-4 | 🔴 FAILED | < 1s |
| `test_tmf_taxonomy_mapping` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_ucum_extra_coverage` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_uninitialized_database_manager` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_view_download_audit_logging` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_watermarked_document_viewing_and_download` | `tests.test_etmf` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_document_version_history_lineage` | `tests.test_etmf_binder_structure_and_history` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_empty_binder_structure` | `tests.test_etmf_binder_structure_and_history` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_partial_binder_structure` | `tests.test_etmf_binder_structure_and_history` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_versions_404_not_found` | `tests.test_etmf_binder_structure_and_history` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_bulk_archival_all_or_nothing_rollback` | `tests.test_etmf_bulk_archival` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_bulk_archival_authorization_and_rejections` | `tests.test_etmf_bulk_archival` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_bulk_archival_partial_success` | `tests.test_etmf_bulk_archival` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_bulk_archival_repeating_safe_and_observable` | `tests.test_etmf_bulk_archival` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_bulk_archival_successful_progression` | `tests.test_etmf_bulk_archival` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_actual_cryptographic_verification` | `tests.test_etmf_compliance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_audit_logs_group_sealing_and_chaining` | `tests.test_etmf_compliance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_background_sealer_lifecycle` | `tests.test_etmf_compliance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_missing_and_invalid_signature_ingestion` | `tests.test_etmf_compliance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_mock_signature_bypass` | `tests.test_etmf_compliance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_signature_extraction_formats` | `tests.test_etmf_compliance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_signature_requirement_rules` | `tests.test_etmf_compliance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_tampering_detection_and_lockout_propagation` | `tests.test_etmf_compliance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_create_authorized_vs_unauthorized` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_creation_date_validation_rejected` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_expiration_update_authorized_vs_unauthorized` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_update_date_validation_rejected` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_expiration_update_authorized_vs_unauthorized` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_expiration_update_date_validation_rejected` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_ingest_authorized_vs_unauthorized` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_ingest_date_validation_rejected` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_manage_expiration_rbac_permissions` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_migration_adds_expiration_columns_idempotently` | `tests.test_etmf_eisf_expiration_metadata` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_audit_attribution` | `tests.test_etmf_expiration_scanner` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_determine_warning_window` | `tests.test_etmf_expiration_scanner` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_execute_expiration_scan_cycle_thresholds` | `tests.test_etmf_expiration_scanner` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_failure_isolation_and_resilience` | `tests.test_etmf_expiration_scanner` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_scanner_idempotency_restart_and_rearming` | `tests.test_etmf_expiration_scanner` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_scanner_shutdown_cancellation` | `tests.test_etmf_expiration_scanner` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_idempotency` | `tests.test_etmf_inbound_email` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_immutability_violation_inbound_email` | `tests.test_etmf_inbound_email` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_invalid_signature_rejection` | `tests.test_etmf_inbound_email` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_multi_attachment_ingestion` | `tests.test_etmf_inbound_email` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_oversized_payload_rejection` | `tests.test_etmf_inbound_email` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_replay_protection` | `tests.test_etmf_inbound_email` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stale_timestamp_rejection` | `tests.test_etmf_inbound_email` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unresolvable_recipient_address` | `tests.test_etmf_inbound_email` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_valid_inbound_email_ingestion` | `tests.test_etmf_inbound_email` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_append_only_transition_history` | `tests.test_etmf_qc` | PRD-QC-005 | 🔴 FAILED | < 1s |
| `test_invalid_status_transition_raises_error` | `tests.test_etmf_qc` | PRD-QC-002 | 🔴 FAILED | < 1s |
| `test_new_document_defaults_to_draft` | `tests.test_etmf_qc` | PRD-QC-001 | 🔴 FAILED | < 1s |
| `test_part11_change_reason_enforcement` | `tests.test_etmf_qc` | PRD-QC-004 | 🔴 FAILED | < 1s |
| `test_qc_history_api_and_audit` | `tests.test_etmf_qc` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_qc_history_api_not_found` | `tests.test_etmf_qc` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_qc_transitions_missing_doc` | `tests.test_etmf_qc` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_role_based_access_controls_and_gates` | `tests.test_etmf_qc` | PRD-QC-003 | 🔴 FAILED | < 1s |
| `test_migration_clean_path` | `tests.test_etmf_qc_invariants` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_migration_upgrade_and_backfill_path` | `tests.test_etmf_qc_invariants` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_automated_redaction_basic` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_automated_redaction_errors` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_automated_redaction_profile_scopes` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_automated_redaction_trial_locked` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_manual_redaction_authorization_and_lock` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_manual_redaction_literal_escaping` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_manual_redaction_span_validation` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_manual_redaction_success` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_redaction_audit_trail_and_provenance` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_redaction_authorization_gates` | `tests.test_etmf_redaction` | PRD-TMF-005 | 🔴 FAILED | < 1s |
| `test_completeness_signature_lifecycle_distinction` | `tests.test_etmf_signatures` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_signature_document_routing_and_classification` | `tests.test_etmf_signatures` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_signature_lifecycle_with_mock_signature` | `tests.test_etmf_signatures` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_post_signature_locking` | `tests.test_etmf_signing_lifecycle` | Trace-13 | 🔴 FAILED | < 1s |
| `test_etmf_signing_happy_path` | `tests.test_etmf_signing_lifecycle` | Trace-13 | 🔴 FAILED | < 1s |
| `test_etmf_signing_reauth_failures` | `tests.test_etmf_signing_lifecycle` | Trace-13 | 🔴 FAILED | < 1s |
| `test_auto_quarantine_site_level_no_site_id` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_binder_export_redaction_representation_policy` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_completeness_site_isolation` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_to_etmf_sync_preserves_scope` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_is_site_level_artifact_helper` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_legacy_records_quarantine_policy` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_raw_original_suppression_without_read_raw` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_regulatory_binder_export_site_isolation` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_id_validation_empty_whitespace` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_scoped_cannot_read_study_level_or_quarantined_documents` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_scoped_no_assigned_sites_fail_closed` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_scoped_users_read_isolation` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_scoped_write_restrictions` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_scoping_on_redactions_and_signatures` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unauthorized_role_denied_on_all_paths` | `tests.test_etmf_site_scope` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_to_etmf_e2e_boundaries` | `tests.test_etmf_sync_provenance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_redaction_derivative_safety` | `tests.test_etmf_sync_provenance` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_sealer_retains_and_validates_reason_for_change` | `tests.test_etmf_sync_provenance` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_designer_criteria_client_retrieval_and_parsing` | `tests.test_execution_eligibility` | PRD-ELIGIBILITY-009, PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_ecrf_context_builder_demographics_and_precedence` | `tests.test_execution_eligibility` | PRD-ELIGIBILITY-010, PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_ecrf_context_builder_kleene_absent_semantics` | `tests.test_execution_eligibility` | PRD-ELIGIBILITY-011, PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_randomization_allocation_rejection_gate` | `tests.test_execution_eligibility` | PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_screening_endpoint_eligible_and_transition` | `tests.test_execution_eligibility` | PRD-ELIGIBILITY-012, PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_screening_endpoint_indeterminate_behavior` | `tests.test_execution_eligibility` | PRD-ELIGIBILITY-014, PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_screening_endpoint_ineligible_transition_and_audit` | `tests.test_execution_eligibility` | PRD-ELIGIBILITY-013, PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_form_submission_approval_audit_manifestation` | `tests.test_form_submissions` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_form_submission_audit_logging` | `tests.test_form_submissions` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_form_submission_invalid_transitions` | `tests.test_form_submissions` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_form_submission_lifecycle_happy_path` | `tests.test_form_submissions` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_form_submission_locks` | `tests.test_form_submissions` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_form_submission_validation` | `tests.test_form_submissions` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_gateway_site_isolation_propagation` | `tests.test_gateway` | Trace-16 | 🔴 FAILED | < 1s |
...
| `test_absent_and_malformed_roles` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_allowed_roles_matrix` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_forbidden_roles_matrix` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_form_lock_and_unlock_lifecycle` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_gateway_bypass_prevention` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lock_status_retrieval` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_locked_write_prevention` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_roles_authorization_restrictions` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_lock_and_unlock_lifecycle` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_subject_lock_and_unlock_lifecycle` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_trial_lock_and_unlock_lifecycle` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_visit_lock_and_unlock_lifecycle` | `tests.test_granular_locks_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_bulk_offline_sync` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_compute_reminders_all_subjects_staff` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_compute_reminders_by_subject_and_end_date_branch` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_deliver_notification_task_exception` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_epro_submission_and_conflict_resolution` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_fhir_prefill_bundle_pipeline` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_foreign_key_and_cascade_lifecycle_integrity` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_instrument_and_assignment_endpoints_and_auditing` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_instrument_and_assignment_orm_persistence` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_notifications_and_reminders_lifecycle` | `tests.test_interop` | Trace-10 | 🔴 FAILED | < 1s |
| `test_pseudonymization_and_pii_stripping` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_subject_content_submission_and_compliance_apis` | `tests.test_interop` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_subject_role_authorization_and_identity_binding` | `tests.test_interop` | Trace-8 | 🔴 FAILED | < 1s |
| `test_bulk_sync_with_valid_signatures_and_tallies` | `tests.test_interop_defeated` | PRD-EDC-007 | 🔴 FAILED | < 1s |
| `test_defeated_record_persistence_on_conflicts` | `tests.test_interop_defeated` | PRD-EDC-008, Trace-9 | 🔴 FAILED | < 1s |
| `test_structural_conflict_on_missing_target` | `tests.test_interop_defeated` | PRD-EDC-008 | 🔴 FAILED | < 1s |
| `test_submit_with_invalid_signature_fails` | `tests.test_interop_defeated` | PRD-EDC-008 | 🔴 FAILED | < 1s |
| `test_submit_with_valid_signature` | `tests.test_interop_defeated` | PRD-EDC-008 | 🔴 FAILED | < 1s |
| `test_build_ecrf_context_mapping` | `tests.test_interop_prescreen` | PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_build_ecrf_context_multiple_and_missing` | `tests.test_interop_prescreen` | PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_no_edc_mutation_boundary` | `tests.test_interop_prescreen` | PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_pre_screen_audit_evidence_non_phi` | `tests.test_interop_prescreen` | PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_pre_screen_eligible` | `tests.test_interop_prescreen` | PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_pre_screen_indeterminate` | `tests.test_interop_prescreen` | PRD-MDR-007 | 🔴 FAILED | < 1s |
| `test_pre_screen_ineligible` | `tests.test_interop_prescreen` | PRD-MDR-007 | 🔴 FAILED | < 1s |
...
| `test_create_central_range_with_null_site_id_allowed` | `tests.test_lab_ranges_crud` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_create_central_range_with_site_id_blocked` | `tests.test_lab_ranges_crud` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_create_lab_reference_range_success` | `tests.test_lab_ranges_crud` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_create_lab_reference_range_unauthorized` | `tests.test_lab_ranges_crud` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_create_lab_reference_range_validation_errors` | `tests.test_lab_ranges_crud` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_get_and_update_lab_reference_range` | `tests.test_lab_ranges_crud` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_list_and_filter_lab_reference_ranges` | `tests.test_lab_ranges_crud` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_soft_delete_lab_reference_range` | `tests.test_lab_ranges_crud` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_update_local_to_central_invariant_enforcement` | `tests.test_lab_ranges_crud` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lab_ranges_comprehensive_e2e_workflow` | `tests.test_lab_ranges_e2e_verification` | PRD-LAB-001 | 🔴 FAILED | < 1s |
| `test_lab_range_evaluation_and_recalculation_gxp` | `tests.test_lab_ranges_recalculate` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lab_range_recalculation_authorized_data_manager` | `tests.test_lab_ranges_recalculate` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lab_range_recalculation_blank_reason` | `tests.test_lab_ranges_recalculate` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lab_range_recalculation_missing_reason` | `tests.test_lab_ranges_recalculate` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lab_range_recalculation_no_match` | `tests.test_lab_ranges_recalculate` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lab_range_recalculation_unauthorized_role` | `tests.test_lab_ranges_recalculate` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_clinical_observation_extended_fields` | `tests.test_lab_reference_range_persistence` | PRD-LAB-001 | 🔴 FAILED | < 1s |
| `test_lab_reference_range_audit_and_triggers` | `tests.test_lab_reference_range_persistence` | PRD-LAB-001 | 🔴 FAILED | < 1s |
| `test_lab_reference_range_crud_and_precision` | `tests.test_lab_reference_range_persistence` | PRD-LAB-001 | 🔴 FAILED | < 1s |
| `test_schema_evolution_migration_upgrade` | `tests.test_lab_reference_range_persistence` | PRD-LAB-001, PRD-QRY-005 | 🔴 FAILED | < 1s |
...
| `test_ledger_sealing_and_validation` | `tests.test_ledger_and_triggers` | PRD-SYS-003 | 🔴 FAILED | < 1s |
| `test_out_of_band_update_triggers_audit_entry` | `tests.test_ledger_and_triggers` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_prevent_audit_ledger_seals_mutation` | `tests.test_ledger_and_triggers` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_prevent_audit_log_mutation` | `tests.test_ledger_and_triggers` | PRD-SYS-001, Trace-1 | 🔴 FAILED | < 1s |
| `test_prevent_hard_delete_on_audited_model` | `tests.test_ledger_and_triggers` | PRD-SYS-002, Trace-1 | 🔴 FAILED | < 1s |
...
| `test_execution_health` | `tests.test_main` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_audit_trigger_logging_on_coding_workflow` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_dictionary_import_job_lifecycle` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_import_failure_rollback_and_failed_state` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_import_invalid_layout_rejected` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_import_unauthorized_roles_forbidden` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_import_unsupported_dictionary_rejected` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lookup_and_indexes` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lookup_endpoints_validation_errors` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_meddra_import_happy_path` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_meddra_lookup_endpoint_happy_path` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_meddra_term_unique_constraint` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_whodrug_import_happy_path` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_whodrug_lookup_endpoint_happy_path` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_whodrug_record_unique_constraint` | `tests.test_medical_coding` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_audit_relevant_workflows` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cache_behavior_and_degradation` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_coding_transitions` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_dictionary_version_isolation` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_import_auth_and_job_status` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lookups_endpoints` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_matcher_normalization_and_scoring_thresholds` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_override_reason_validation` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_parser_fixtures` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_uncodable_query_generation_and_pii_isolation` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_upversioning_ledger_outcomes` | `tests.test_medical_coding_engine` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_impact_analysis_meddra_and_whodrug_lifecycle` | `tests.test_medical_coding_impact` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_auto_coding_on_observation_creation` | `tests.test_medical_coding_lifecycle` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_coder_action_accept_and_override_lifecycle` | `tests.test_medical_coding_lifecycle` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_mid_confidence_persists_as_suggestions` | `tests.test_medical_coding_lifecycle` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cache_aside_and_stale_fallback` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cache_degradation_and_stale_on_error` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cache_ttl_configuration` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cache_unavailability_graceful_degradation` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_meddra_matching_integration` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_normalize_term[Clinical history of hepatitises-clinic hepatitis]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_normalize_term[Mild headache-headache]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_normalize_term[Onset of acute gastritis-gastritis]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_normalize_term[Severe recurring pain, chronic-pain]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_similarity_computations` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[allergies-allergy]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[clinical-clinic]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[headaches-headache]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[hepatitises-hepatitis]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[infected-infect]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[meningitis-meningitis]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[pain-pain]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[severely-severe]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[ss-ss]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stem_word[vomiting-vomit]` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_token_cosine_similarity_empty` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_whodrug_matching_integration` | `tests.test_medical_coding_matcher` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_run_migrations_real_sqlite` | `tests.test_migrate` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_direct_transition_open_to_resolved` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_email_delivery_channel_failure_and_exhaustion` | `tests.test_notifications` | PRD-SYS-003 | 🔴 FAILED | < 1s |
| `test_email_delivery_channel_success` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lifecycle_transitions_and_justifications` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_multi_channel_edge_case_in_app_succeeds_email_exhausts` | `tests.test_notifications` | PRD-SYS-003 | 🔴 FAILED | < 1s |
| `test_notification_creation_and_auditing` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_notification_detail_visibility` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_notification_list_visibility_and_filtering` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_notifications_database_schema_creation` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_notifications_health_check` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_notifications_negative_security_paths` | `tests.test_notifications` | PRD-SYS-004 | 🔴 FAILED | < 1s |
| `test_webhook_delivery_channel_failure_and_retry_backoff` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_webhook_delivery_channel_success` | `tests.test_notifications` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_doa_signoff_automatic_archival_handoff` | `tests.test_org_integration_e2e` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_doa_signoff_tampered_payload_rejected` | `tests.test_org_integration_e2e` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_eisf_completeness_participation` | `tests.test_org_integration_e2e` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_gateway_openapi_aggregation_with_org` | `tests.test_org_integration_e2e` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_gateway_org_proxy_routing` | `tests.test_org_integration_e2e` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cro_affiliation_validation` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_delegation_of_authority_flow` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_gxp_audit_logging_and_actor_context` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_health_endpoint` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_org_audit_log_append_only` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_organization_and_site_relationship` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_organization_crud_api` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_personnel_and_sitestaff_alias` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_personnel_assignments_crud` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_personnel_crud_api` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_resolve_assignments_endpoint` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_crud_api` | `tests.test_org_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_clinical_capture_provenance_and_version_stamping` | `tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_designer_amendment_immutability_and_race_safety` | `tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_designer_amendment_signature_validation` | `tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_document_change_rationale_mandatory_rules` | `tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_linkage_and_version_history_lineage` | `tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_qc_transitions_immutability` | `tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_exact_version_consent_and_reconsent_gating` | `tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_non_destructive_reconciliation_and_multi_hop` | `tests.test_protocol_amendments_validation_suite` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_capa_creation_validations_and_closed_deviation` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_capa_transition_edge_cases_and_optimistic_locking` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_capa_update_edge_cases_and_optional_fields` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_database_manager_uninitialized_raises_exception` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_deviation_lifecycle_and_traceability_fields` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_deviation_not_found_404` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_deviation_rca_capa_relationships_and_cascading` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_endpoint_change_reason_check_via_mock` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_lifespan_coverage` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_list_deviations_filters` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_missing_change_reasons_unauthorized` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_quality_audit_log_append_only` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_quality_database_schema_creation` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_quality_health_check` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_sqlite_foreign_key_constraints` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_sqlite_pragma_exception_handling` | `tests.test_quality` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_quality_sentinel_complete_protocol` | `tests.test_quality_sentinel` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_quality_sentinel_incomplete_protocol_detects_errors` | `tests.test_quality_sentinel` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_quality_sentinel_router_endpoint` | `tests.test_quality_sentinel` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_audit_log_endpoint_properties` | `tests.test_quality_workflow` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_capa_approval_closure_requires_quality_oversight` | `tests.test_quality_workflow` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_capa_creation_validations` | `tests.test_quality_workflow` | PRD-SUB-001 | 🔴 FAILED | < 1s |
| `test_capa_lifecycle_transitions` | `tests.test_quality_workflow` | PRD-SUB-001 | 🔴 FAILED | < 1s |
| `test_capa_updates_and_concurrency` | `tests.test_quality_workflow` | PRD-SUB-001 | 🔴 FAILED | < 1s |
| `test_create_and_list_deviations` | `tests.test_quality_workflow` | PRD-SYS-001, Trace-7 | 🔴 FAILED | < 1s |
| `test_create_and_update_rca` | `tests.test_quality_workflow` | PRD-SYS-001 | 🔴 FAILED | < 1s |
| `test_mutation_without_change_reason_rejected` | `tests.test_quality_workflow` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_permission_failure_leaves_no_misleading_audit_entry` | `tests.test_quality_workflow` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_read_only_roles_forbidden` | `tests.test_quality_workflow` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_successful_mutation_creates_audit_log_and_is_atomic` | `tests.test_quality_workflow` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_transition_capa_sig_token_matrix` | `tests.test_quality_workflow` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_digest_window_configurations` | `tests.test_queries_escalation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_escalation_idempotency` | `tests.test_queries_escalation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_escalation_missing_ids_fallback` | `tests.test_queries_escalation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_no_aging_queries` | `tests.test_queries_escalation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_startup_shutdown_and_resilience` | `tests.test_queries_escalation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_threshold_boundaries_and_escalation` | `tests.test_queries_escalation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_concurrent_randomization_unique_and_monotonic` | `tests.test_randomization_concurrency` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_forced_failure_rolls_back_atomically` | `tests.test_randomization_concurrency` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_randomization_entities_audit_trail_and_soft_delete` | `tests.test_randomization_persistence` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_randomization_entities_hard_delete_prevented` | `tests.test_randomization_persistence` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_randomization_entities_trial_lock_conformity` | `tests.test_randomization_persistence` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_can_access_site` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cross_site_query_read_isolation` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_cross_site_unblind_denied_with_alert` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_audit_logs_gated_to_auditors` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_document_transition_auditor_forbidden` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_edl_creation_auditor_forbidden` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_edl_update_auditor_forbidden` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_etmf_ingest_auditor_forbidden` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_execution_observation_creation_auditor_forbidden` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_execution_subject_creation_auditor_forbidden` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_execution_visit_creation_auditor_forbidden` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_external_monitor_aliases` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_external_monitor_eisf_denies_writes_allows_reads` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_external_monitor_permissions_matrix` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_external_monitor_principal_resolution` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_get_principal_from_request` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_has_permission` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_mask_payload_recursive` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_principal_agreement_with_middleware_coercion` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_require_permission_dependency` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_role_aliases_normalization` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_role_normalization_list` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_role_normalization_string` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_rtsm_role_aliases_normalization` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_rtsm_role_aware_masking` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_rtsm_role_permissions` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_verify_is_auditor_allows_auditors` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_verify_is_auditor_denies_non_auditors` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_verify_not_auditor_allows_others` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_verify_not_auditor_denies_auditors` | `tests.test_rbac` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_subject_consent_blocking_and_reconsent_lifecycle` | `tests.test_reconsent_blocking` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_evaluate_resupply_boundaries` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_hard_delete_prevented_for_supply_entities` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_insufficient_stock_rejection_and_rollback` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_invalid_site_kit_relationship_rejection` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_locked_site_rejection` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_resupply_threshold_breach_and_deduplication` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_inventory_unique_constraint` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_successful_dispensation_endpoint` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_supply_entities_audit_trail_and_soft_delete` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_trial_locking_conformity` | `tests.test_rtsm_supply` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_deterministic_output_sorting` | `tests.test_sae_reconciliation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_execution_client_and_adapter_methods` | `tests.test_sae_reconciliation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_pure_comparison_differing_fields` | `tests.test_sae_reconciliation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_pure_comparison_missing_on_either_side` | `tests.test_sae_reconciliation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_pure_comparison_same_code_different_terms` | `tests.test_sae_reconciliation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_pure_function_generate_stable_event_key` | `tests.test_sae_reconciliation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_pure_function_normalize_edc_ae_to_sae` | `tests.test_sae_reconciliation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_pure_function_normalize_external_icsr_to_saes` | `tests.test_sae_reconciliation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_reconciliation_jobs_read_endpoints_and_gating` | `tests.test_sae_reconciliation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_reconciliation_persistence_and_audit` | `tests.test_sae_reconciliation` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_reconciliation_runs_read_endpoints` | `tests.test_sae_reconciliation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_reconciliation_version_index_increment` | `tests.test_sae_reconciliation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_safety_mutations_negative_signatures` | `tests.test_sae_reconciliation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_safety_reads_negative_signatures` | `tests.test_sae_reconciliation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_alert_dispatch_failure_exception` | `tests.test_sae_reconciliation_jobs` | Trace-14 | 🔴 FAILED | < 1s |
| `test_alert_dispatch_failure_non_2xx` | `tests.test_sae_reconciliation_jobs` | Trace-14 | 🔴 FAILED | < 1s |
| `test_notifications_gxp_medical_monitor_alert` | `tests.test_sae_reconciliation_jobs` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_reconciliation_job_failure_path` | `tests.test_sae_reconciliation_jobs` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_trigger_and_poll_reconciliation_job_success` | `tests.test_sae_reconciliation_jobs` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_database_manager_uninitialized_raises_exception` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_invalid_xml_validation_fails` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_list_audit_logs_endpoint` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_missing_change_reason_fails_mutations` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_missing_v2_headers_or_change_reason_fails` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_nonexistent_resources_return_404` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_safety_audit_log_immutable_ledger` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_safety_case_lifecycle` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_safety_database_schema_creation` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_safety_export_job_lifecycle` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_safety_health_check` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_successful_export_and_transmission` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unauthenticated_requests_are_rejected` | `tests.test_safety_service` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_sdv_automatic_verification_drop_compliance` | `tests.test_sdv` | PRD-QRY-006 | 🔴 FAILED | < 1s |
| `test_sdv_signoff_endpoints_rbac_and_target_validation` | `tests.test_sdv` | PRD-QRY-005 | 🔴 FAILED | < 1s |
| `test_clinical_observation_sdv_defaults` | `tests.test_sdv_tsdv_persistence` | PRD-QRY-005, PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_sdv_automatic_verification_drop` | `tests.test_sdv_tsdv_persistence` | PRD-QRY-005, PRD-QRY-006 | 🔴 FAILED | < 1s |
| `test_sdv_sign_off_persistence_and_audit` | `tests.test_sdv_tsdv_persistence` | PRD-QRY-005 | 🔴 FAILED | < 1s |
| `test_sdv_signoff_endpoint_and_idempotency` | `tests.test_sdv_tsdv_persistence` | PRD-QRY-005, PRD-QRY-006 | 🔴 FAILED | < 1s |
| `test_sdv_signoff_page_visit_scopes` | `tests.test_sdv_tsdv_persistence` | PRD-QRY-005, PRD-QRY-006 | 🔴 FAILED | < 1s |
| `test_tsdv_config_persistence` | `tests.test_sdv_tsdv_persistence` | PRD-QRY-007 | 🔴 FAILED | < 1s |
...
| `test_protocol_capture_and_reconciliation_lifecycle` | `tests.test_study_migration` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_pure_python_transition_guard` | `tests.test_subject_randomization_lifecycle` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_stratification_factors_locking` | `tests.test_subject_randomization_lifecycle` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_subject_initial_state_and_persistence` | `tests.test_subject_randomization_lifecycle` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_subject_state_transitions` | `tests.test_subject_randomization_lifecycle` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_unblinding_and_withdrawal_behavior` | `tests.test_subject_randomization_lifecycle` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_events_captured_in_part_11_audit_history` | `tests.test_system_coding_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_manual_coding_resolution_associates_with_query_and_closes_it` | `tests.test_system_coding_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_resolving_query_reverts_assignment_to_uncoded` | `tests.test_system_coding_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_uncodable_term_creates_query_pending_and_actionable_query` | `tests.test_system_coding_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_uncodable_term_query_creation_is_idempotent` | `tests.test_system_coding_queries` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_audit_log_creation_on_escalate` | `tests.test_tickets_escalation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_bounded_priority_advancement` | `tests.test_tickets_escalation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_cooldown_gating_and_idempotency` | `tests.test_tickets_escalation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_escalation_eligibility_rules` | `tests.test_tickets_escalation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_notification_deduplication_and_partial_failures` | `tests.test_tickets_escalation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_startup_shutdown_and_resilience` | `tests.test_tickets_escalation` | Trace-14 | 🔴 FAILED | < 1s |
| `test_end_to_end_tickets_and_notifications_handshake` | `tests.test_tickets_integration_seam` | Trace-14 | 🔴 FAILED | < 1s |
| `test_escalation_worker_notifications_retry_mechanics` | `tests.test_tickets_integration_seam` | Trace-14 | 🔴 FAILED | < 1s |
...
| `test_end_to_end_escalation_worker_flow_and_retries` | `tests.test_tickets_notifications_seam` | Trace-14 | 🟢 PASSED | < 1s |
| `test_end_to_end_ticket_creation_and_comment_flow` | `tests.test_tickets_notifications_seam` | Trace-14 | 🟢 PASSED | < 1s |
...
| `test_notification_failure_isolation` | `tests.test_tickets_notifications_integration` | Trace-14 | 🔴 FAILED | < 1s |
| `test_notification_idempotency` | `tests.test_tickets_notifications_integration` | Trace-14 | 🔴 FAILED | < 1s |
| `test_ticket_assignment_notification` | `tests.test_tickets_notifications_integration` | Trace-14 | 🔴 FAILED | < 1s |
| `test_ticket_comment_notification` | `tests.test_tickets_notifications_integration` | Trace-14 | 🔴 FAILED | < 1s |
| `test_ticket_transition_notification` | `tests.test_tickets_notifications_integration` | Trace-14 | 🔴 FAILED | < 1s |
| `test_update_ticket_notifications` | `tests.test_tickets_notifications_integration` | Trace-14 | 🔴 FAILED | < 1s |
| `test_end_to_end_escalation_worker_flow_and_retries` | `tests.test_tickets_notifications_seam` | Trace-14 | 🔴 FAILED | < 1s |
| `test_end_to_end_ticket_creation_and_comment_flow` | `tests.test_tickets_notifications_seam` | Trace-14 | 🔴 FAILED | < 1s |
| `test_comments_creation_and_retrieval_scoped` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_list_ticket_audit_logs_endpoint` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_missing_change_reason_fails_mutations` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_nonexistent_resources_return_404` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_ticket_audit_log_immutable_ledger` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_ticket_concurrent_reference_generation` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_ticket_scoped_audit_logs` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_audit_logs_pagination` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_audit_logs_query_boundaries` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_audit_logs_time_filtering` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_auditor_comments_access` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_database_schema_creation` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_enums_and_models_attributes` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_get_by_reference` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_health_check` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_in_scope_success_and_self_audit` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_lifecycle` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_optimistic_locking_and_explicit_endpoints` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_rbac_auditor_cannot_mutate_but_can_read` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_scope_aware_filtering` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_site_scope_filtering_audit_logs_unfiltered` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_terminal_state_rejection` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_unauthorized_site_scope_blocking` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_tickets_validation_invalid_enums` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
| `test_unauthenticated_requests_are_rejected` | `tests.test_tickets_service` | Trace-14 | 🔴 FAILED | < 1s |
...
| `test_security_gate_unauthenticated_requests` | `tests.test_translation_recovery` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_translation_error_status_and_rollback` | `tests.test_translation_recovery` | Trace-12 | 🔴 FAILED | < 1s |
| `test_translation_status_and_listing_success` | `tests.test_translation_recovery` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_worker_context_and_session_cleanup` | `tests.test_translation_recovery` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_audit_safe_context_binds_and_cleans_up` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_audit_safe_context_cleans_up_on_error` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_background_translation_records_user_audit` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_identifier_sanitization_during_translation` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_multi_language_localization_and_hint_system` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_rules_compilation_and_artifact_generation` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_study_published_event_triggers_translation` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_study_published_expired_timestamp_rejection` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_study_published_invalid_signature_rejection` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_translation_validation_failure` | `tests.test_translator` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_site_and_visit_locks` | `tests.test_trial_lock` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_subject_and_form_locks` | `tests.test_trial_lock` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_trial_lock_freeze` | `tests.test_trial_lock` | PRD-SYS-003, Trace-3 | 🔴 FAILED | < 1s |
| `test_api_tsdv_config_validation_rules` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_api_tsdv_configuration_rbac` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_api_tsdv_evaluation_integration_and_context_errors` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_api_tsdv_immutable_enrollment_index_stability` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_pure_deterministic_sampling` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_pure_different_seeds_produce_different_values` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_pure_evaluation_sampling_models` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_pure_field_requirement_precedence` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_pure_first_n_selection` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_pure_percentage_boundaries` | `tests.test_tsdv` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_api_tsdv_config_authorization_and_upsert` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_api_tsdv_config_validation` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_api_tsdv_evaluation_endpoint` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_evaluation_models` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_field_required_precedence` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_subject_selection_boundaries` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_subject_selection_deterministic` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🔴 FAILED | < 1s |
| `test_tsdv_subject_selection_first_n` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🔴 FAILED | < 1s |
...
| `test_site_level_data_isolation` | `tests.validation.environment_integrity_tests` | PRD-SYS-004 | 🔴 FAILED | < 1s |
