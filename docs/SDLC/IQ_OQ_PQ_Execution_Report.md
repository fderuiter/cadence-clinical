...
- **Total Automated Test Cases Run:** 1130
- **Passed:** 1130 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| `test_cdisc_xml_structure_validation` | `tests.validation.environment_integrity_tests` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_cryptographic_tamper_evident_safeguards` | `tests.validation.environment_integrity_tests` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_environment_integrity` | `tests.validation.environment_integrity_tests` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_site_level_data_isolation` | `tests.validation.environment_integrity_tests` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_gxp_compliance_drifts_identified` | `tests.validation.gxp_compliance_suite` | *Regression/Helper* | 🟢 PASSED | < 1s |
