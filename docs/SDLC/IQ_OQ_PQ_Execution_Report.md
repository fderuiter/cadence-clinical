...
| `test_evaluate_tsdv_requirement_pure` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🟢 PASSED | < 1s |
| `test_is_field_required` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🟢 PASSED | < 1s |
| `test_is_subject_selected_for_sdv` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🟢 PASSED | < 1s |
| `test_tsdv_config_api_authorization_and_validation` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🟢 PASSED | < 1s |
| `test_tsdv_config_api_upsert_and_retrieval` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🟢 PASSED | < 1s |
| `test_tsdv_evaluation_endpoint` | `tests.test_tsdv_logic` | PRD-QRY-007 | 🟢 PASSED | < 1s |
