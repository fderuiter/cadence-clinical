...
| `test_catalog_invariants_uniqueness_integrity_and_extensions` | `tests.validation.dia_tmf_validation_suite` | PRD-TMF-001, PRD-TMF-002 | 🟢 PASSED | < 1s |
| `test_milestone_mandatory_artifact_validation` | `tests.validation.dia_tmf_validation_suite` | PRD-TMF-004 | 🟢 PASSED | < 1s |
| `test_site_level_classification_drift_protection` | `tests.validation.dia_tmf_validation_suite` | PRD-TMF-003 | 🟢 PASSED | < 1s |
