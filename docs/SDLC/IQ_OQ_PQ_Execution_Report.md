...
- **Total Automated Test Cases Run:** 2065
- **Passed:** 2065 🟢
- **Total Automated Test Cases Run:** 2058
- **Passed:** 2058 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| `test_parallel_capa_status_transitions_concurrency` | `tests.test_quality_concurrency` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_parallel_rca_updates_concurrency` | `tests.test_quality_concurrency` | *Regression/Helper* | 🟢 PASSED | < 1s |
