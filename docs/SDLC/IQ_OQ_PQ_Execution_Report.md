...
| `test_ecoa_diary_alert_permissions_secondary` | `tests.test_rbac` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_ecoa_permissions_and_transport_models` | `tests.test_rbac` | PRD-ECOA-001 | 🟢 PASSED | < 1s |
