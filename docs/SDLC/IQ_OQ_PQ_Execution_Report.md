...
| `test_main_local_only_mode` | `tests.test_vulnerabilities` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_main_local_only_mode_fails_on_ledger_error` | `tests.test_vulnerabilities` | *Regression/Helper* | 🟢 PASSED | < 1s |
