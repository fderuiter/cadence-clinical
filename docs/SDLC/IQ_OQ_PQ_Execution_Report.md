...
| `test_archive_etmf_creates_files_and_hashes` | `tests.test_automated_pipeline` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_deploy_orchestrator_success` | `tests.test_automated_pipeline` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_verify_approvals_failure_missing_ticket` | `tests.test_automated_pipeline` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_verify_approvals_success` | `tests.test_automated_pipeline` | *Regression/Helper* | 🟢 PASSED | < 1s |
