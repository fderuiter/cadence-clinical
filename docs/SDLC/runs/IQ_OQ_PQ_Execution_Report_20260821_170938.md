...
*Execution Date:* 2026-08-21 17:09:38 UTC
...
- **Total Automated Test Cases Run:** 2688
- **Passed:** 0 🟢
- **Unverified (Draft):** 2688 ⚪
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| :--- | :--- | :--- | :--- | :--- |
| `test_cra_allocations_rbac_reassignment_workload` | `apps.ctms.tests.test_ctms` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_create_and_list_studies_rbac` | `apps.ctms.tests.test_ctms` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_get_audit_trail_rbac` | `apps.ctms.tests.test_ctms` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_monitoring_visit_invalid_state_and_findings` | `apps.ctms.tests.test_ctms` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_monitoring_visit_scheduling_respects_cra_allocation` | `apps.ctms.tests.test_ctms` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_monitoring_visit_workflow_happy_path` | `apps.ctms.tests.test_ctms` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_monitoring_visit_workflow_rbac_denials` | `apps.ctms.tests.test_ctms` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_recruitment_records_crud_and_audit` | `apps.ctms.tests.test_ctms` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_milestones_crud_and_audit` | `apps.ctms.tests.test_ctms` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_protocol_deviation_lifecycle_and_capa_escalation` | `apps.ctms.tests.test_deviations_and_issues` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_etmf_artifact_synchronization` | `apps.ctms.tests.test_etmf_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_procedure_financials_and_invoice_disbursement` | `apps.ctms.tests.test_financials_auto_payables` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ip_shipment_receipt_dispensation_and_reconciliation` | `apps.ctms.tests.test_ip_accountability` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_rbqm_kri_breach_detection_and_adaptive_risk_scoring` | `apps.ctms.tests.test_rbqm_kri` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_greenlight_gatekeeper_workflow` | `apps.ctms.tests.test_site_startup` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_startup_and_regulatory_milestones` | `apps.ctms.tests.test_site_startup` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_concurrent_multi_study_ingestion` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_cypher_injection_and_special_characters` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_database_disconnection_mid_transaction` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_deadlock_and_failing_commit` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_direct_usdmstudy_object_input` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_empty_and_missing_id_payloads` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_large_scale_protocol_stress_harness` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_legacy_and_hybrid_schema_aliases` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_malformed_type_structures` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_rollback_itself_fails_gracefully` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_sync_wrapper_with_db_failure` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_zero_designs_warning` | `apps.designer.tests.test_adversarial_usdm` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_extract_and_commit_endpoints` | `apps.designer.tests.test_ai_usdm_digitization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cycle_detection_on_extracted_rules` | `apps.designer.tests.test_ai_usdm_digitization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_end_to_end_synthesis_time` | `apps.designer.tests.test_ai_usdm_digitization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_missing_change_reason_rejected` | `apps.designer.tests.test_ai_usdm_digitization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_neo4j_usdm_graph_integrity` | `apps.designer.tests.test_ai_usdm_digitization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_protocol_entity_extraction` | `apps.designer.tests.test_ai_usdm_digitization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_designer_amendment_branching_success` | `apps.designer.tests.test_amendments` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_designer_amendment_branching_unapproved_baseline_rejection` | `apps.designer.tests.test_amendments` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_designer_amendment_impact_endpoint_direct` | `apps.designer.tests.test_amendments` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_designer_semantic_diff_and_impact_summary` | `apps.designer.tests.test_amendments` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_adversarial_concept_deduplication_and_multiple_references` | `apps.designer.tests.test_challenger_usdm_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_cypher_query_validation_and_safety` | `apps.designer.tests.test_challenger_usdm_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_empty_protocol_and_missing_optional_fields` | `apps.designer.tests.test_challenger_usdm_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_entity_counts_complex_multi_arm_protocol` | `apps.designer.tests.test_challenger_usdm_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_injection_resistance_and_special_characters` | `apps.designer.tests.test_challenger_usdm_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_relational_edge_semantics_and_directions` | `apps.designer.tests.test_challenger_usdm_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adversarial_transaction_rollback_on_query_failure` | `apps.designer.tests.test_challenger_usdm_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_check_dict_for_value` | `apps.designer.tests.test_concept_locks` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_concept_mutations_locked_active_recruiting` | `apps.designer.tests.test_concept_locks` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_cdash_usdm_csv_mapping_fidelity` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_collaborative_workspace_review_workflow` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_crf_authoring_and_global_library_instantiation` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_declarative_rule_generation_edit_checks` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_failure_recovery_high_availability` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_fhir_esource_readiness_prefill` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gxp_change_reason_justification` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_immutable_audit_attribution` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_real_time_contextual_preview` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_regulatory_protocol_document_export` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_role_based_authorization_gates` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_simulation_dry_run_cycle_detection` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_tenant_data_isolation` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_version_pinning_and_lock_enforcement` | `apps.designer.tests.test_crf_builder_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_cdash_usdm_csv_mapping_fidelity` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_collaborative_workspace_review_workflow` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_crf_authoring_global_library_instantiation` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_declarative_rule_generation_and_edit_checks` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_failure_recovery_and_high_availability` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_fhir_esource_readiness_cdash_pre_fill` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gxp_change_reason_justification` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_immutable_audit_attribution` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_real_time_contextual_preview` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_regulatory_and_protocol_document_export` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_role_based_authorization_gates` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_simulation_and_dry_run_cycle_detection` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_and_tenant_data_isolation` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_version_pinning_and_lock_enforcement` | `apps.designer.tests.test_crf_requirements_mapping` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_crf_synthesizer_class_service` | `apps.designer.tests.test_crf_synthesizer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_synthesize_from_raw_dictionary_and_list` | `apps.designer.tests.test_crf_synthesizer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_synthesize_from_usdm_study_model` | `apps.designer.tests.test_crf_synthesizer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_synthesize_with_biomedical_concept_value_level_metadata` | `apps.designer.tests.test_crf_synthesizer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_widget_representation_resolution_all_types` | `apps.designer.tests.test_crf_synthesizer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_blinding_constraints_on_ui_data_rendering` | `apps.designer.tests.test_designer_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_fda_compliant_pdf_generation_protocol` | `apps.designer.tests.test_designer_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_field_level_ingestion_validations` | `apps.designer.tests.test_designer_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gxp_audit_enforcement_default_justification` | `apps.designer.tests.test_designer_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gxp_audit_enforcement_missing_justification` | `apps.designer.tests.test_designer_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gxp_audit_enforcement_read_only_bypass` | `apps.designer.tests.test_designer_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gxp_audit_enforcement_system_user_bypass` | `apps.designer.tests.test_designer_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ie_criteria_logical_mapping_to_ecrf` | `apps.designer.tests.test_designer_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_spreadsheet_ingestion_sheet_structure` | `apps.designer.tests.test_designer_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_rules_crud_endpoints` | `apps.designer.tests.test_designer_rules` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_invalid_data_element_default_unit_fails` | `apps.designer.tests.test_global_library` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_invalid_mismatched_type_payload_fails` | `apps.designer.tests.test_global_library` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_mutation_creation_requires_non_empty_change_reason` | `apps.designer.tests.test_global_library` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_mutation_update_requires_non_empty_reason_for_change` | `apps.designer.tests.test_global_library` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_arm_detail_validation` | `apps.designer.tests.test_global_library` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_data_element_detail_validation` | `apps.designer.tests.test_global_library` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_form_detail_validation` | `apps.designer.tests.test_global_library` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_visit_detail_validation` | `apps.designer.tests.test_global_library` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_library_object_active_study_lock` | `apps.designer.tests.test_library_locks` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_library_object_author_self_approval_block` | `apps.designer.tests.test_library_locks` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_library_object_rbac_permissions` | `apps.designer.tests.test_library_locks` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_search_terminology_endpoint_bypass_and_refresh` | `apps.designer.tests.test_terminology_validation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_search_terminology_endpoint_cache_behavior` | `apps.designer.tests.test_terminology_validation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_terminology_search_cache_direct` | `apps.designer.tests.test_terminology_validation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_atomic_rollback_leaves_graph_unmodified` | `apps.designer.tests.test_transactional_usdm_ingest` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_commit_usdm_graph_with_empty_arrays` | `apps.designer.tests.test_transactional_usdm_ingest` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ingest_incomplete_study_with_empty_arrays` | `apps.designer.tests.test_transactional_usdm_ingest` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_linear_scaling_and_no_timeout_on_large_payload` | `apps.designer.tests.test_transactional_usdm_ingest` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_mock_state_unchanged_on_transaction_failure` | `apps.designer.tests.test_transactional_usdm_ingest` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pydantic_domain_models` | `apps.designer.tests.test_usdm_graph_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_graph_importer_in_memory_state_sync` | `apps.designer.tests.test_usdm_graph_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_graph_importer_sync_wrapper` | `apps.designer.tests.test_usdm_graph_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_graph_importer_transactional_rollback` | `apps.designer.tests.test_usdm_graph_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_graph_importer_v4_ingestion` | `apps.designer.tests.test_usdm_graph_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_importer_alias_compatibility` | `apps.designer.tests.test_usdm_graph_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_importer_warning_unknown_concepts` | `apps.designer.tests.test_usdm_graph_importer` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_round_trip_canonical_serialization_verification` | `apps.designer.tests.test_usdm_serialization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_serialize_usdm_canonical_json` | `apps.designer.tests.test_usdm_serialization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_serialize_usdm_canonical_yaml` | `apps.designer.tests.test_usdm_serialization` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_tier1_ecrf_layout_synthesis_engine` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_etmf_edl_seeding_milestones_and_zones` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_soa_matrix_compilation_from_graph` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_soa_matrix_compiler_usdm_model` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_usdm_graph_ingestion_transactional` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_atomic_rollback_on_invalid_usdm_payload` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_edge_cases_empty_and_unmapped_entities` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier3_end_to_end_zero_click_build_pipeline` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier4_execution_performance_benchmark_under_5s` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier4_part11_gxp_audit_and_change_justification` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier4_phase2_oncology_real_world_protocol` | `apps.designer.tests.test_zero_click_usdm_build` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_approved_content_retrieval_and_cache` | `apps.econsent.tests.test_econsent_translations` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_site_level_data_isolation` | `apps.eisf.tests.test_eisf_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_canonical_catalog_ingestion_validations` | `apps.etmf.tests.test_etmf` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_completeness_checking_transitions` | `apps.etmf.tests.test_etmf` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_completeness_from_catalog` | `apps.etmf.tests.test_etmf` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_completeness_from_catalog_across_versions` | `apps.etmf.tests.test_etmf` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_deterministic_and_complete_binder_export` | `apps.etmf.tests.test_etmf` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_edl_definitions_and_crud` | `apps.etmf.tests.test_etmf` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_explicit_and_default_taxonomy_version_roundtrip_and_legacy_interpretability` | `apps.etmf.tests.test_etmf` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_qualify_catalog_cutover_and_extension_persistence` | `apps.etmf.tests.test_etmf` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_site_aware_completeness` | `apps.etmf.tests.test_etmf` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_custom_milestones_and_backward_compatibility` | `apps.etmf.tests.test_etmf_edl_seeding` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_live_async_session_edl_seeding_and_idempotency` | `apps.etmf.tests.test_etmf_edl_seeding` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_offline_in_memory_edl_seeding_all_zones` | `apps.etmf.tests.test_etmf_edl_seeding` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_repository_integration_edl_seeding` | `apps.etmf.tests.test_etmf_edl_seeding` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_seed_edl_rest_endpoint` | `apps.etmf.tests.test_etmf_edl_seeding` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_append_only_transition_history` | `apps.etmf.tests.test_etmf_qc` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_invalid_status_transition_raises_error` | `apps.etmf.tests.test_etmf_qc` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_new_document_defaults_to_draft` | `apps.etmf.tests.test_etmf_qc` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_part11_change_reason_enforcement` | `apps.etmf.tests.test_etmf_qc` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_role_based_access_controls_and_gates` | `apps.etmf.tests.test_etmf_qc` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_automated_redaction_basic` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_automated_redaction_errors` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_automated_redaction_profile_scopes` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_automated_redaction_trial_locked` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_manual_redaction_authorization_and_lock` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_manual_redaction_literal_escaping` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_manual_redaction_span_validation` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_manual_redaction_success` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_redaction_audit_trail_and_provenance` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_redaction_authorization_gates` | `apps.etmf.tests.test_etmf_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_etmf_post_signature_locking` | `apps.etmf.tests.test_etmf_signing_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_etmf_signing_happy_path` | `apps.etmf.tests.test_etmf_signing_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_etmf_signing_reauth_failures` | `apps.etmf.tests.test_etmf_signing_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_dual_read_fallback_legacy_content` | `apps.etmf.tests.test_storage_migration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_dual_read_object_storage` | `apps.etmf.tests.test_storage_migration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_migrate_etmf_blobs_to_s3_script_lifecycle` | `apps.etmf.tests.test_storage_migration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_active_version_selection` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_artifact_parent_identification` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_canonical_11_zones` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_complete_catalog_manifest_and_uniqueness` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_explicit_version_selection` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_mandatory_artifacts_failures` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_mandatory_artifacts_success` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hierarchy_integrity_v3_2_0_complete` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_immutability_properties` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_no_database_dependencies` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reproducibility_and_version_isolation` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_resolve_artifact_failures` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_resolve_artifact_success` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_standard_versus_extension_policy` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validate_hierarchy_failures` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validate_hierarchy_success` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_version_isolation` | `apps.etmf.tests.test_tmf_reference_model` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_amendment_cloning_preserves_base_version` | `apps.execution.tests.test_amendment_migration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_reconsent_gating_blocks_form_submission` | `apps.execution.tests.test_amendment_migration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reconsent_unlock_enables_v2_entry` | `apps.execution.tests.test_amendment_migration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_subject_historical_visits_preserve_v1_schema` | `apps.execution.tests.test_amendment_migration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_endpoints_offload_to_threadpool` | `apps.execution.tests.test_anonymization_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_batch_sign_off_all_locks` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_sign_off_audit_manifestation_capture` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_sign_off_happy_path_form` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_sign_off_locks_and_atomic_rollback` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_sign_off_mismatched_bindings_and_no_write` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_sign_off_non_lock_rollback` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_sign_off_pi_only` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_sign_off_subject_resolution` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_sign_off_token_replay` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_sign_off_visit_resolution` | `apps.execution.tests.test_batch_sign_off` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_advisory_locking_pg_outbox_worker` | `apps.execution.tests.test_bg_processing_coordination` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_advisory_locking_pg_queries_escalation` | `apps.execution.tests.test_bg_processing_coordination` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_advisory_locking_pg_sealer` | `apps.execution.tests.test_bg_processing_coordination` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_background_verification_failure_resilience` | `apps.execution.tests.test_bg_processing_coordination` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_integrity_verification_runs_in_background` | `apps.execution.tests.test_bg_processing_coordination` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_adae_trtemfl_logic` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_advs_chg_pchg_computations` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_adam_export_success` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_api_sdtm_export_success` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_sdtm_export_with_supp_records` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_unauthenticated_export_rejection` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_validation_failure_logging` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_partial_date_imputation_detailed` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdtm_age_derivation` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdtm_sequence_assignment` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdtm_supplemental_qualifiers` | `apps.execution.tests.test_biostat_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_adam_all_datasets_and_formats` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_all_domain_extractors_and_supp_records` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_biostat_adsl_and_validation_rules` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_biostat_bundle_formats` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_biostat_dates_helpers` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_biostat_deid_and_scrubbing_helpers` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_biostat_extractors_and_derivations` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_biostat_mappings_metadata` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_odm_xml_serialization_and_audit_trail` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_deidentified_csv_and_zip_export` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_export_validation_failure_handling` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_export_wizard_parameterized_scenarios` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ibm_360_float_encoding_roundtrip` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_infer_variable_type_and_length` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_invalid_requests_and_unauthorized` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_odm_xml_single_list_and_helpers` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sas_xpt_trailing_and_all_blank_rows_roundtrip` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sas_xpt_v5_serialization_and_deserialization` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sas_xpt_v8_serialization_and_deserialization` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdtm_all_domains_and_formats` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdtm_domain_export_success` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_xpt_external_dataset_zero_header_count` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_xpt_reader_error_handling` | `apps.execution.tests.test_biostat_exports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_dataset_json_pydantic_v2_model_and_2d_matrix` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_deid_age_capping_and_string_redaction` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_deid_deterministic_date_shift_range_and_invariants` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_deid_error_message_scrubbing_pii` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_deid_longitudinal_parity_across_multi_domain_patient_journey` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_deid_partial_dates_and_numeric_sas_dates` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ibm360_collision_with_dot_missing_value` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ibm360_float_codec_exhaustive_boundaries` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_odm_xml_21cfr_part11_audit_trail_embedded` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_odm_xml_escaping_and_special_characters` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_odm_xml_namespaces_and_root_attributes` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validator_controlled_terminology_violation_code` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validator_duplicate_sequence_code` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validator_empty_studyid_usubjid_code` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validator_missing_required_variables_code` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validator_null_flavor_inconsistency_code` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validator_referential_inconsistency_code` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validator_supplemental_qualifier_violation_code` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_xpt_80byte_card_framing_and_padding_stress` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_xpt_blank_character_row_truncation` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_xpt_large_dataset_roundtrip_integrity` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_xpt_name_length_and_label_limits_handling` | `apps.execution.tests.test_biostat_exports_adversarial` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_data_lock_6_tier_hierarchy_and_mutation_blocking` | `apps.execution.tests.test_challenger_1_empirical_verification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lab_ingestion_parsers_and_delimiter_sniffing` | `apps.execution.tests.test_challenger_1_empirical_verification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lab_reference_range_selection_and_critical_sae_alerts` | `apps.execution.tests.test_challenger_1_empirical_verification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_medical_coding_fuzzy_matching_and_stemming_edge_cases` | `apps.execution.tests.test_challenger_1_empirical_verification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_medical_coding_upversioning_and_reclassification_impact` | `apps.execution.tests.test_challenger_1_empirical_verification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sig_token_step_up_replay_prevention_and_unlock_justification` | `apps.execution.tests.test_challenger_1_empirical_verification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_odm_xml_audit_records_and_entity_escaping` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_datalock_6_tier_field_level_blocking` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_datalock_6_tier_form_visit_subject_site_study_hierarchy` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_datalock_step_up_signature_and_unlock_justification_boundaries` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hipaa_gdpr_deidentification_rules` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lab_ingestion_malformed_csv_and_corrupt_data` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lab_ingestion_malformed_hl7_and_fhir` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lab_unit_conversions_and_extreme_range_boundaries` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_medical_coding_exact_threshold_boundaries` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_medical_coding_uncodable_and_extreme_inputs` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_medical_coding_upversioning_and_idempotency_stress` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sas_xpt_v5_v8_card_padding_and_ibm_floats` | `apps.execution.tests.test_challenger_empirical_stress` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_datalock_model_aliases_and_properties` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_datalock_sqlmodel_relational_persistence` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_lock_status_and_tree_endpoints` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hard_lock_requires_valid_sig_token` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hierarchical_lock_inheritance_field_blocks_single_observation` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hierarchical_lock_inheritance_form_blocks_field_observations` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hierarchical_lock_inheritance_site_blocks_subjects_and_forms` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hierarchical_lock_inheritance_study_blocks_all` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hierarchical_lock_inheritance_subject_blocks_visits_and_observations` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lock_and_unlock_router_branches_and_validation` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_trial_lock_manager_methods_and_reset` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unlock_enforces_min_50_char_justification` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unlocked_entity_allows_subsequent_mutations` | `apps.execution.tests.test_data_locks_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_scenario_cross_form_edit_checks_and_auto_resolve` | `apps.execution.tests.test_edit_checks_scenarios` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_scenario_longitudinal_predecessor_draft_and_complete` | `apps.execution.tests.test_edit_checks_scenarios` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_scenario_skip_logic_and_cascading_nullification` | `apps.execution.tests.test_edit_checks_scenarios` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_smart_type_coercion_and_localized_guards` | `apps.execution.tests.test_evaluator` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cdisc_xml_structure_validation` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cryptographic_tamper_evident_safeguards` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ecrf_version_control_history` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_edc_archival_integration` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_edc_audit_trail_and_signatures` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_edc_concurrent_review_locks` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_edc_electronic_signatures` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_edc_reconsent_and_versioning` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_event_driven_site_compliance_cache` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_fda_compliant_pdf_generation_econsent` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_query_lifecycle_states` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_subject_enrollment_blocking` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_submission_archival_integration` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_submission_audit_trail` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_submission_e_signatures` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_submission_locks` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_submission_version_control` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_system_generated_validation_queries` | `apps.execution.tests.test_execution_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_designer_criteria_client_retrieval_and_parsing` | `apps.execution.tests.test_execution_eligibility` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ecrf_context_builder_demographics_and_precedence` | `apps.execution.tests.test_execution_eligibility` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ecrf_context_builder_kleene_absent_semantics` | `apps.execution.tests.test_execution_eligibility` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_randomization_allocation_rejection_gate` | `apps.execution.tests.test_execution_eligibility` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_screening_endpoint_eligible_and_transition` | `apps.execution.tests.test_execution_eligibility` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_screening_endpoint_indeterminate_behavior` | `apps.execution.tests.test_execution_eligibility` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_screening_endpoint_ineligible_transition_and_audit` | `apps.execution.tests.test_execution_eligibility` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_age_sex_stratified_reference_range_evaluation` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_batch_status_list_and_not_found` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_ingest_json_endpoint` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_ingest_multipart_file_endpoint` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_store_filtering_by_study` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_consent_version_stamping_on_ingestion` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_critical_sae_alert_trigger` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_csv_batch_ingestion_success` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_csv_parser_resilience_and_errors` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_fhir_diverse_structures_and_types` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_fhir_observation_json_ingestion` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hl7_and_fhir_parser_resilience` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hl7_batch_ingestion_oru_r01` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hl7_diverse_segments_and_abnormal_flags` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lab_ranges_specificity_and_tie_breaking` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_parse_helpers_unit_coverage` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_recalculate_range_flags_full_coverage` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ucum_unit_conversion_integration` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unsupported_format_and_empty_payload` | `apps.execution.tests.test_lab_batch_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_lab_test_master_crud_and_audit` | `apps.execution.tests.test_lab_master_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lab_unit_conversion_crud_and_audit` | `apps.execution.tests.test_lab_master_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_absent_boundaries` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_age_boundaries` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_convert_lab_unit_db_and_fallback` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_critical_boundaries_and_exclusion` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_deterministic_ties` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_evaluate_lab_value_all_indicators` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_is_deleted_filtering` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lab_reference_range_synonyms_and_audit` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_lab_reference_range_synonyms_update_and_audit` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_negative_age_matching` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_no_matching_rule_behavior` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_normal_boundaries_and_inclusion` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sex_and_all_fallback` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_and_source_precedence` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task1_divergence_select_reference_range_vs_normalize_gender` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task1_exact_m_rejected_against_f_only_range` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task1_sex_alias_strings` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task1_sex_u_matching` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task2_age_inclusive_boundaries` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task2_age_none_matching` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task2_age_span_tie_breaking` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task2_zero_and_negative_age_evaluation` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task3_site_id_combinations` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task3_study_id_isolation` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task3_test_code_isolation` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task3_unknown_lab_source_fallback` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task4_convert_lab_unit_edge_cases` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_task4_evaluate_lab_value_edge_cases` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tie_breaking_with_none_bounds` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unit_matching` | `apps.execution.tests.test_lab_ranges` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_lab_ranges_comprehensive_e2e_workflow` | `apps.execution.tests.test_lab_ranges_e2e_verification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_clinical_observation_extended_fields` | `apps.execution.tests.test_lab_reference_range_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_lab_reference_range_audit_and_triggers` | `apps.execution.tests.test_lab_reference_range_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_lab_reference_range_crud_and_precision` | `apps.execution.tests.test_lab_reference_range_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_schema_evolution_migration_upgrade` | `apps.execution.tests.test_lab_reference_range_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_in_memory_accessibility_auditing` | `apps.execution.tests.test_layout_validator_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_audit_log_captures_all_coding_actions` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_batch_assignment_with_gxp_audit_logging` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_coding_queue_retrieval_and_filtering` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_discrepancy_query_escalation_lifecycle` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_impact_analysis_reclassification_and_mutation` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_matcher_normalization_and_fuzzy_scoring` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_meddra_hierarchy_search_and_traversal` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_parsers_meddra_and_whodrug_ascii_lines` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_single_coder_action_accept_and_override` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_upversioning_impact_analysis_endpoint` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_whodrug_atc_and_ingredient_lookup` | `apps.execution.tests.test_medical_coding_workbench` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_pdf_redaction_engine_bounding_box` | `apps.execution.tests.test_pdf_redactor` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pdf_redaction_engine_purges_metadata_and_fields` | `apps.execution.tests.test_pdf_redactor` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pdf_redaction_overlay_generation` | `apps.execution.tests.test_pdf_redactor` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_zero_phi_leak_in_redacted_pdf` | `apps.execution.tests.test_phi_redaction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_concurrent_connection_isolation_and_no_weakref_errors` | `apps.execution.tests.test_pool_state_eviction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pool_connection_state_eviction` | `apps.execution.tests.test_pool_state_eviction` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_manual_physical_paper_consent_override` | `apps.execution.tests.test_pubsub_auto_enrollment` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pubsub_auto_enrollment_screening` | `apps.execution.tests.test_pubsub_auto_enrollment` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_activation_compliance_validation` | `apps.execution.tests.test_pubsub_auto_enrollment` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_bulk_sdv_signoff_batch_binding_mismatch` | `apps.execution.tests.test_sdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_bulk_sdv_signoff_happy_path` | `apps.execution.tests.test_sdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_bulk_sdv_signoff_input_validation` | `apps.execution.tests.test_sdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_bulk_sdv_signoff_rbac_and_idempotency` | `apps.execution.tests.test_sdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdv_automatic_verification_drop_compliance` | `apps.execution.tests.test_sdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdv_signoff_endpoints_rbac_and_target_validation` | `apps.execution.tests.test_sdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_clinical_observation_sdv_defaults` | `apps.execution.tests.test_sdv_tsdv_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_item_level_sdv_data_model_and_state_machine` | `apps.execution.tests.test_sdv_tsdv_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdv_automatic_verification_drop` | `apps.execution.tests.test_sdv_tsdv_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdv_sign_off_persistence_and_audit` | `apps.execution.tests.test_sdv_tsdv_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdv_signoff_endpoint_and_idempotency` | `apps.execution.tests.test_sdv_tsdv_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdv_signoff_page_visit_scopes` | `apps.execution.tests.test_sdv_tsdv_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_config_persistence` | `apps.execution.tests.test_sdv_tsdv_persistence` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_downstream_replay_cache_redis_reset` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_downstream_replay_cache_redis_success` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_redis_consumption_fallback_on_exception` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_redis_consumption_replay_blocked` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_redis_consumption_success` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_redis_reset` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_verify_and_consume_sig_token_expired` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_verify_and_consume_sig_token_mismatched_user` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_verify_and_consume_sig_token_replay_blocked` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_verify_and_consume_sig_token_success` | `apps.execution.tests.test_sig_token_verifier` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_signature_manifestation_lifecycle` | `apps.execution.tests.test_signature_manifestation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_signature_sign_and_verify_lifecycle_success` | `apps.execution.tests.test_signature_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verify_mock_fails` | `apps.execution.tests.test_signature_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verify_tampered_fails` | `apps.execution.tests.test_signature_router` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_db_migration_cloning_and_sealing` | `apps.execution.tests.test_subject_migration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_trial_lock_freeze` | `apps.execution.tests.test_trial_lock` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_tsdv_config_validation_rules` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_tsdv_configuration_rbac` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_tsdv_evaluation_integration_and_context_errors` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_tsdv_immutable_enrollment_index_stability` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_tsdv_pure_deterministic_sampling` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_pure_different_seeds_produce_different_values` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_pure_evaluation_sampling_models` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_pure_field_requirement_precedence` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_pure_first_n_selection` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_pure_percentage_boundaries` | `apps.execution.tests.test_tsdv` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_tsdv_config_authorization_and_upsert` | `apps.execution.tests.test_tsdv_logic` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_tsdv_config_validation` | `apps.execution.tests.test_tsdv_logic` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_tsdv_evaluation_endpoint` | `apps.execution.tests.test_tsdv_logic` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_evaluation_models` | `apps.execution.tests.test_tsdv_logic` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_field_required_precedence` | `apps.execution.tests.test_tsdv_logic` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_subject_selection_boundaries` | `apps.execution.tests.test_tsdv_logic` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_subject_selection_deterministic` | `apps.execution.tests.test_tsdv_logic` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tsdv_subject_selection_first_n` | `apps.execution.tests.test_tsdv_logic` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_file_record_creation_and_defaults` | `apps.fileshare.tests.test_domain_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_file_record_validation_errors` | `apps.fileshare.tests.test_domain_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_guest_link_validity` | `apps.fileshare.tests.test_domain_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_share_grant_lifecycle_and_expiry` | `apps.fileshare.tests.test_domain_models` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_download_url_permissions_and_watermarking` | `apps.fileshare.tests.test_fileshare_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_guest_link_creation` | `apps.fileshare.tests.test_fileshare_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_health_check` | `apps.fileshare.tests.test_fileshare_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_multipart_upload_url_generation` | `apps.fileshare.tests.test_fileshare_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_singlepart_upload_url_generation` | `apps.fileshare.tests.test_fileshare_endpoints` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_signature_verification_replay_attack_prevention` | `apps.gateway.tests.test_double_auth` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_role_insufficient_auth` | `apps.gateway.tests.test_double_auth` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_token_expiration` | `apps.gateway.tests.test_double_auth` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_create_demo_session` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_eisf_gateway_site_isolation_propagation` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_gateway_cors_headers` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gateway_local_secret_bypasses_audience_check` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gateway_notifications_header_enforcement_and_spoofing_prevention` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gateway_proxy_eisf_headers_propagation` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gateway_rate_limiting` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_proxy_requests_no_auth` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_signature_gated_mutation_enforcement` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_gated_mutation_expired_token` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_gated_mutation_mismatched_action` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_token_altered_signature_rejected` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_token_credentials_not_logged_or_returned` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_invalid_credentials` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_role_insufficient` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_study_designer_role_allowed` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_success` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_verification_with_batch_id` | `apps.gateway.tests.test_gateway` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_environment_integrity` | `apps.gateway.tests.test_gateway_compliance` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_downstream_signature_gated_endpoint_expired_token` | `apps.gateway.tests.test_security_middleware` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_downstream_signature_gated_endpoint_mismatched_action` | `apps.gateway.tests.test_security_middleware` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_downstream_signature_gated_endpoint_replay_blocked` | `apps.gateway.tests.test_security_middleware` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_downstream_signature_gated_endpoint_requires_sig_token` | `apps.gateway.tests.test_security_middleware` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_downstream_signature_gated_endpoint_valid_sig_token` | `apps.gateway.tests.test_security_middleware` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_verify_sig_token_helper_scenarios` | `apps.gateway.tests.test_security_middleware` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_offline_submission_conflict_resolution_lifecycles` | `apps.interop.tests.test_ecoa_coverage` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_structural_conflict_on_missing_or_deleted_targets` | `apps.interop.tests.test_ecoa_coverage` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_notifications_and_reminders_lifecycle` | `apps.interop.tests.test_interop` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_subject_role_authorization_and_identity_binding` | `apps.interop.tests.test_interop` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_bulk_sync_with_valid_signatures_and_tallies` | `apps.interop.tests.test_interop_defeated` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_defeated_record_persistence_on_conflicts` | `apps.interop.tests.test_interop_defeated` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_structural_conflict_on_missing_target` | `apps.interop.tests.test_interop_defeated` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_submit_with_invalid_signature_fails` | `apps.interop.tests.test_interop_defeated` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_submit_with_valid_signature` | `apps.interop.tests.test_interop_defeated` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_build_ecrf_context_mapping` | `apps.interop.tests.test_interop_prescreen` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_build_ecrf_context_multiple_and_missing` | `apps.interop.tests.test_interop_prescreen` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_no_edc_mutation_boundary` | `apps.interop.tests.test_interop_prescreen` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pre_screen_audit_evidence_non_phi` | `apps.interop.tests.test_interop_prescreen` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pre_screen_eligible` | `apps.interop.tests.test_interop_prescreen` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pre_screen_indeterminate` | `apps.interop.tests.test_interop_prescreen` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pre_screen_ineligible` | `apps.interop.tests.test_interop_prescreen` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_epro_quarantine_sync_pipeline` | `apps.interop.tests.test_interop_quarantine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_epro_version_mismatch_quarantine_pipeline` | `apps.interop.tests.test_interop_quarantine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_signature_validation_failures` | `apps.interop.tests.test_sync_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signature_validation_happy_path` | `apps.interop.tests.test_sync_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_strategy_client_wins_existing` | `apps.interop.tests.test_sync_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_strategy_client_wins_no_existing` | `apps.interop.tests.test_sync_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_strategy_merge_independent_fields` | `apps.interop.tests.test_sync_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_strategy_merge_lww_existing_wins` | `apps.interop.tests.test_sync_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_strategy_merge_lww_incoming_wins` | `apps.interop.tests.test_sync_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_strategy_merge_lww_timestamp_tie` | `apps.interop.tests.test_sync_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_strategy_server_wins` | `apps.interop.tests.test_sync_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_audit_log_created_on_article_creation` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_audit_log_immutability_enforced` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_audit_log_written_on_every_transition` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_four_eyes_different_user_can_approve` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_four_eyes_same_editor_cannot_approve` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_invalid_transition_draft_to_published_raises` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_invalid_transition_published_to_draft_raises` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_no_notification_dispatched_on_draft_save` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_notification_dispatched_on_published` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reason_not_required_on_draft_save` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reason_required_on_approve_raises_without_it` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reason_required_on_publish_raises_without_it` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_transition_approved_to_published` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_transition_archived_to_draft` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_transition_draft_to_in_review` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_transition_in_review_to_approved` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_transition_in_review_to_rejected` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_valid_transition_rejected_to_draft` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_version_index_increments_on_publish` | `apps.knowledge.tests.test_article_lifecycle` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_create_and_get_category` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_delete_category_lifecycle` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_api_list_categories_persona_scoping` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_create_category_duplicate_name_or_slug_fails` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_create_category_with_nonexistent_parent_fails` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_create_child_category_with_parent` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_create_root_category` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_delete_nonexistent_or_already_deleted_category_raises` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_category_by_id_and_slug` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_list_categories_persona_filtering` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_soft_delete_category` | `apps.knowledge.tests.test_categories` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_emergency_unblinding_generates_notification` | `apps.notifications.tests.test_clinical_workflow_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_query_aging_generates_notification` | `apps.notifications.tests.test_clinical_workflow_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sdv_drop_generates_notification` | `apps.notifications.tests.test_clinical_workflow_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_trial_lock_generates_notification` | `apps.notifications.tests.test_clinical_workflow_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_email_delivery_channel_failure_and_exhaustion` | `apps.notifications.tests.test_notifications` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_multi_channel_edge_case_in_app_succeeds_email_exhausts` | `apps.notifications.tests.test_notifications` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_notifications_negative_security_paths` | `apps.notifications.tests.test_notifications` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_training_log_crud_and_validation` | `apps.org.tests.test_org_integration_e2e` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_training_log_invalid_signature_fails` | `apps.org.tests.test_org_integration_e2e` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_training_log_signing_and_archival_handoff` | `apps.org.tests.test_org_integration_e2e` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_training_log_unauthorized_access` | `apps.org.tests.test_org_integration_e2e` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_training_log_update_missing_justification_fails` | `apps.org.tests.test_org_integration_e2e` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_audit_engagement_lifecycle` | `apps.quality.tests.test_audit_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_audit_findings_and_one_click_capa_promotion` | `apps.quality.tests.test_audit_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_inspection_readiness_dossier_compilation_and_tamper_seal` | `apps.quality.tests.test_audit_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_automated_quality_event_ingestion_api` | `apps.quality.tests.test_eqms_comprehensive` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_capa_action_items_and_effectiveness_evaluations` | `apps.quality.tests.test_eqms_comprehensive` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_multi_methodology_rca_5whys_and_fishbone` | `apps.quality.tests.test_eqms_comprehensive` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_capa_creation_validations` | `apps.quality.tests.test_quality_workflow` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_capa_lifecycle_transitions` | `apps.quality.tests.test_quality_workflow` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_capa_updates_and_concurrency` | `apps.quality.tests.test_quality_workflow` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_create_and_list_deviations` | `apps.quality.tests.test_quality_workflow` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_create_and_update_rca` | `apps.quality.tests.test_quality_workflow` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_ctq_factor_lifecycle` | `apps.quality.tests.test_rbqm_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_kri_batch_evaluation_and_statistical_z_scores` | `apps.quality.tests.test_rbqm_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_kri_definitions_and_auto_seeding` | `apps.quality.tests.test_rbqm_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_qtl_tolerance_limit_and_csr_narrative` | `apps.quality.tests.test_rbqm_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_risk_profile_computation_and_ranking` | `apps.quality.tests.test_rbqm_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_regulatory_clock_approaching_and_overdue_indicators` | `apps.quality.tests.test_serious_breaches` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_serious_breach_confirmation_and_status_progression` | `apps.quality.tests.test_serious_breaches` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_serious_breach_reporting_and_initial_clock` | `apps.quality.tests.test_serious_breaches` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_statutory_discovery_clock_preservation_on_confirmation` | `apps.quality.tests.test_serious_breaches` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_pure_function_generate_stable_event_key` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pure_function_normalize_edc_ae_to_sae` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pure_function_normalize_external_icsr_to_saes` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reconciliation_jobs_read_endpoints_and_gating` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reconciliation_persistence_and_audit` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reconciliation_runs_read_endpoints` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_reconciliation_version_index_increment` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_safety_mutations_negative_signatures` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_safety_reads_negative_signatures` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_terminology_cache_functionality` | `apps.safety.tests.test_sae_reconciliation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_alert_dispatch_failure_exception` | `apps.safety.tests.test_sae_reconciliation_jobs` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_alert_dispatch_failure_non_2xx` | `apps.safety.tests.test_sae_reconciliation_jobs` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_cross_app_ticket_ingestion_from_execution_edc` | `apps.tickets.tests.test_cross_app_ingestion` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_21cfr_part11_esignature_capture` | `apps.tickets.tests.test_part11_signatures_attachments` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_audited_evidence_attachments` | `apps.tickets.tests.test_part11_signatures_attachments` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_rca_validation_on_major_and_critical_closure` | `apps.tickets.tests.test_part11_signatures_attachments` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_audit_log_creation_on_escalate` | `apps.tickets.tests.test_tickets_escalation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_bounded_priority_advancement` | `apps.tickets.tests.test_tickets_escalation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_cooldown_gating_and_idempotency` | `apps.tickets.tests.test_tickets_escalation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_escalation_eligibility_rules` | `apps.tickets.tests.test_tickets_escalation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_notification_deduplication_and_partial_failures` | `apps.tickets.tests.test_tickets_escalation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_startup_shutdown_and_resilience` | `apps.tickets.tests.test_tickets_escalation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_end_to_end_tickets_and_notifications_handshake` | `apps.tickets.tests.test_tickets_integration_seam` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_escalation_worker_notifications_retry_mechanics` | `apps.tickets.tests.test_tickets_integration_seam` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_publish_notification_non_2xx_failure` | `apps.tickets.tests.test_tickets_notifications_client` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_publish_notification_success` | `apps.tickets.tests.test_tickets_notifications_client` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_publish_notification_transport_exception` | `apps.tickets.tests.test_tickets_notifications_client` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_notification_failure_isolation` | `apps.tickets.tests.test_tickets_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_notification_idempotency` | `apps.tickets.tests.test_tickets_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ticket_assignment_notification` | `apps.tickets.tests.test_tickets_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ticket_comment_notification` | `apps.tickets.tests.test_tickets_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ticket_transition_notification` | `apps.tickets.tests.test_tickets_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_update_ticket_notifications` | `apps.tickets.tests.test_tickets_notifications_integration` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_end_to_end_escalation_worker_flow_and_retries` | `apps.tickets.tests.test_tickets_notifications_seam` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_end_to_end_ticket_creation_and_comment_flow` | `apps.tickets.tests.test_tickets_notifications_seam` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_comments_creation_and_retrieval_scoped` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_list_ticket_audit_logs_endpoint` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_missing_change_reason_fails_mutations` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_nonexistent_resources_return_404` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ticket_audit_log_immutable_ledger` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ticket_concurrent_reference_generation` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_ticket_scoped_audit_logs` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_audit_logs_pagination` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_audit_logs_query_boundaries` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_audit_logs_time_filtering` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_auditor_comments_access` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_database_schema_creation` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_enums_and_models_attributes` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_get_by_reference` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_health_check` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_in_scope_success_and_self_audit` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_lifecycle` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_optimistic_locking_and_explicit_endpoints` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_rbac_auditor_cannot_mutate_but_can_read` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_scope_aware_filtering` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_site_scope_filtering_audit_logs_unfiltered` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_terminal_state_rejection` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_unauthorized_site_scope_blocking` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tickets_validation_invalid_enums` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unauthenticated_requests_are_rejected` | `apps.tickets.tests.test_tickets_service` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_web_amendment_branching_and_diff_contracts` | `apps.web.tests.test_amendment_diff` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_web_execution_reconsent_gating_and_subject_impact` | `apps.web.tests.test_amendment_diff` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_21_cfr_part_11_dual_credential_signature_capture` | `apps.web.tests.test_econsent` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_comprehension_quiz_evaluation_and_threshold_enforcement` | `apps.web.tests.test_econsent` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_icf_builder_modular_clauses_linked_to_protocol_version` | `apps.web.tests.test_econsent` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_extract_ports_from_command` | `packages.cli.tests.test_ports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_get_discovered_service_ports` | `packages.cli.tests.test_ports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_is_port_in_use_and_find_available_port` | `packages.cli.tests.test_ports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_load_categorized_ports_compose` | `packages.cli.tests.test_ports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_load_categorized_ports_fallback_on_missing` | `packages.cli.tests.test_ports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_parse_port_entry_variations` | `packages.cli.tests.test_ports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_resolve_all_service_ports_batch` | `packages.cli.tests.test_ports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_resolve_service_port_collision` | `packages.cli.tests.test_ports` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_pre_flush_justification_rejection` | `packages.database.tests.test_compliance_pre_flush` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_freeze_blocking_writes` | `packages.database.tests.test_compliance_pre_flush` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sync_and_async_map_database_exceptions` | `packages.database.tests.test_compliance_pre_flush` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_trial_freeze_blocking_writes` | `packages.database.tests.test_compliance_pre_flush` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_utc_datetime_type_decorator_enforcement` | `packages.database.tests.test_compliance_pre_flush` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_map_database_exceptions_decorator` | `packages.database.tests.test_database_managers` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_ledger_sealing_and_validation` | `packages.database.tests.test_ledger_and_triggers` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_prevent_audit_log_mutation` | `packages.database.tests.test_ledger_and_triggers` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_prevent_hard_delete_on_audited_model` | `packages.database.tests.test_ledger_and_triggers` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_age_capping_and_edge_cases` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_compliance_profiles` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_date_shifting_and_edge_cases` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_detections_all_categories` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hmac_pseudonymization_determinism` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_manifest_tamper_evident_asymmetric` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_manifest_tamper_evident_symmetric` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_no_raw_matched_values_persisted` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_normalize_and_cap_age_direct` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_overlap_resolution_comprehensive` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_source_documents_remain_unchanged` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_transforms_all_strategies` | `packages.deid.tests.test_deidentification` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_all_services_have_ports` | `packages.hexagonal.tests.test_hexagonal_architecture` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_no_singular_adapter_directory` | `packages.hexagonal.tests.test_hexagonal_architecture` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_consent_form_record_immutability_domain` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_consent_signature_immutability_domain` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_safety_audit_log_immutability_domain` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sqlalchemy_audit_repository_persistence` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sqlalchemy_consent_repository_persistence` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_sqlalchemy_subject_repository_persistence` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_subject_lifecycle_pure_domain_transitions` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_subject_stratification_factors_locking_domain` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unblinding_and_withdrawal_domain` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_workflows_with_in_memory_repositories` | `packages.hexagonal.tests.test_hexagonal_domain` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_api_routers_contain_no_direct_db_calls` | `packages.hexagonal.tests.test_hexagonal_ports_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_designer_graph_modifications_with_mock_repositories` | `packages.hexagonal.tests.test_hexagonal_ports_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_domain_models_contain_zero_database_imports` | `packages.hexagonal.tests.test_hexagonal_ports_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_relational_services_execute_database_disabled` | `packages.hexagonal.tests.test_hexagonal_ports_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_signed_consent_immutability_pure_python_validation` | `packages.hexagonal.tests.test_hexagonal_ports_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_subject_status_transitions_pure_python_validation` | `packages.hexagonal.tests.test_hexagonal_ports_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_audit_records_ip_and_custom_timestamp` | `packages.security.tests.test_audit` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_hard_delete_is_prevented` | `packages.security.tests.test_audit` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_insert_generates_audit_log` | `packages.security.tests.test_audit` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_soft_delete_generates_audit_log` | `packages.security.tests.test_audit` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_subject_notification_skips_clinical_auditing` | `packages.security.tests.test_audit` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_update_generates_audit_log` | `packages.security.tests.test_audit` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_dual_custody_negative_duplicate_shares` | `packages.security.tests.test_cryptography` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_dual_custody_negative_malformed_share` | `packages.security.tests.test_cryptography` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_dual_custody_negative_mismatched_versions` | `packages.security.tests.test_cryptography` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_dual_custody_negative_single_share` | `packages.security.tests.test_cryptography` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_dual_custody_negative_tampered_share` | `packages.security.tests.test_cryptography` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_dual_custody_positive` | `packages.security.tests.test_cryptography` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_encryption_decryption_with_rotation` | `packages.security.tests.test_cryptography` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_key_splitting` | `packages.security.tests.test_cryptography` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_commit_within_active_transaction` | `packages.security.tests.test_sqlmodel_audit_store` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pluggable_sqlmodel_store_async` | `packages.security.tests.test_sqlmodel_audit_store` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pluggable_sqlmodel_store_sync` | `packages.security.tests.test_sqlmodel_audit_store` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_minio_storage_adapter_env_and_config` | `packages.storage.tests.test_storage_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_s3_storage_adapter_empty_data_and_generic_errors` | `packages.storage.tests.test_storage_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_s3_storage_adapter_integrity_failure` | `packages.storage.tests.test_storage_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_s3_storage_adapter_multipart_lifecycle` | `packages.storage.tests.test_storage_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_s3_storage_adapter_not_found_handling` | `packages.storage.tests.test_storage_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_s3_storage_adapter_presigned_urls` | `packages.storage.tests.test_storage_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_s3_storage_adapter_put_and_get_lifecycle` | `packages.storage.tests.test_storage_adapters` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_js_reordered_helper_functions` | `scripts.tests.test_ast_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_python_edited_and_reordered` | `scripts.tests.test_ast_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_python_imports_merged_and_sorted` | `scripts.tests.test_ast_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_python_overlapping_logical_edits_fallback` | `scripts.tests.test_ast_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_python_reordered_helper_functions` | `scripts.tests.test_ast_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_classification_driven_multi_site_export` | `scripts.tests.test_classification_multi_site_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_unresolved_site_level_omit_manually` | `scripts.tests.test_classification_multi_site_export` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_aggregate_eligibility_evaluation` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_eligibility_criterion_compatibility_and_enums` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_evaluate_criteria_group_helper` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_evaluate_structured_expression_helper` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_evaluation_all_operators` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_evaluation_incompatible_types_graceful_handling` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_evaluation_kleene_indeterminate_propagation` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_parse_invalid_syntax` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_parse_logical_and_nested_expressions` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_parse_simple_expressions` | `scripts.tests.test_eligibility_engine` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_eligibility_criteria_crud_endpoints` | `scripts.tests.test_eligibility_mdr` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_eligibility_criteria_immutability` | `scripts.tests.test_eligibility_mdr` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_eligibility_criteria_usdm_projection` | `scripts.tests.test_eligibility_mdr` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_eligibility_criteria_validation_failures` | `scripts.tests.test_eligibility_mdr` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_git_merge_driver_cli_conflict_and_markers` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_git_merge_driver_cli_non_overlapping_success` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gitattributes_configuration_mapping` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_merge_generic_json_value_collision_fail_fast` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_merge_markdown_text` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_merge_markdown_text_overlapping` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_merge_secrets_baseline` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_merge_secrets_baseline_structural_mismatch_fail_fast` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_merge_secrets_baseline_top_level_scalar_collision` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_merge_secrets_baseline_value_collision_fail_fast` | `scripts.tests.test_git_merge_driver` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_fail_fast_without_report_and_draft_flag` | `scripts.tests.test_gxp_fail_fast` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_missing_report_gxp_sync_dry_run` | `scripts.tests.test_gxp_fail_fast` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_success_with_draft_flag` | `scripts.tests.test_gxp_fail_fast` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_label_based_backlog_gating` | `scripts.tests.test_sync_github_project` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_terminology_cache_prevents_db_queries` | `scripts.tests.test_transformers` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_endpoint_returns_nested_schema_and_fast` | `scripts.tests.test_transformers` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_usdm_validation_error_on_invalid_data` | `scripts.tests.test_transformers` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_translation_error_status_and_rollback` | `scripts.tests.test_translation_recovery` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_validate_dependencies_fails_on_forbidden_package` | `scripts.tests.test_validate_dependencies` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_validate_dependencies_passes_on_clean_package_json` | `scripts.tests.test_validate_dependencies` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_tier1_feature01_coding_queue_and_filter` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature02_meddra_and_whodrug_traversal` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature03_single_and_batch_coding_assignment` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature04_dictionary_upversioning_impact` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature05_query_escalation_and_resolution` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature06_relational_datalock_persistence` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature07_hierarchical_lock_inheritance` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature08_dual_signature_step_up_token` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature09_unlock_justification_enforcement` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature10_multi_format_lab_ingestion` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature11_ucum_normalization_and_range_eval` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature12_lab_discrepancy_and_sae_auto_queries` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature13_sas_transport_binary_export` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature14_cdisc_odm_xml_export_with_audits` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature15_cdisc_dataset_json_export` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature16_deidentified_csv_export` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier1_feature17_ui_router_and_navigation_metadata` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary01_empty_lab_payload_rejected` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary02_invalid_hl7_segments_rejected` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary03_unlock_justification_under_50_chars_rejected` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary04_hard_lock_without_step_up_token_rejected` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary05_incompatible_ucum_unit_conversion` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary06_nonexistent_dictionary_term_resolution` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary07_invalid_sdtm_domain_export_rejected` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary08_unauthorized_lock_action_rejected` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary09_replay_sig_token_prevention` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier2_boundary10_deidentification_empty_demographics` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier3_pairwise01_form_lock_then_medical_coding` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier3_pairwise02_out_of_range_lab_then_subject_lock` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier3_pairwise03_batch_coding_then_biostat_export` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier3_pairwise04_subject_lock_followed_by_lab_ingestion` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier3_pairwise05_upversioning_impact_then_query_escalation` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier3_pairwise06_hard_lock_step_up_then_unlock_and_export` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier4_scenario01_oncology_trial_multisite_lock` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier4_scenario02_high_throughput_lab_batch_ingestion` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier4_scenario03_meddra_upversioning_and_batch_coding` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier4_scenario04_regulatory_submission_bundle_generation` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_tier4_scenario05_full_lifecycle_e2e_trial_workflow` | `tests.e2e.test_phase1_e2e_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_build_worker_suffix_uniqueness` | `tests.test_harness_isolation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_service_database_names_length_and_format` | `tests.test_harness_isolation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_should_provision_postgres_controller_boundary` | `tests.test_harness_isolation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_should_provision_postgres_worker` | `tests.test_harness_isolation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_simulated_concurrent_runs_have_disjoint_databases` | `tests.test_harness_isolation` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_catalog_cross_version_integrity` | `tests.validation.dia_tmf_validation_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_milestone_mandatory_artifacts` | `tests.validation.dia_tmf_validation_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_site_level_classification_drift` | `tests.validation.dia_tmf_validation_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_gxp_compliance_drifts_identified` | `tests.validation.gxp_compliance_suite` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
| `test_formatting_and_whitespace_immunity` | `tests.validation.test_offline_schema_drift` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_pending_delta_schema_drift` | `tests.validation.test_offline_schema_drift` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_simulated_field_name_rename_drift` | `tests.validation.test_offline_schema_drift` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_simulated_type_mismatch_drift` | `tests.validation.test_offline_schema_drift` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
| `test_submissions_schema_drift` | `tests.validation.test_offline_schema_drift` | *Regression/Helper* | ⚪ UNVERIFIED | N/A |
...
- **Timestamp:** 2026-08-21 17:09:38 UTC
- **Meaning / Purpose:** GxP Dynamic Execution Run Record
- **Cryptographic Hash (SHA-256):** ef48e0228f1aca06f2424602dbbc519f21b9f444d111f0b39cc339cf302d3592

-----BEGIN CERTIFICATE-----
MIIDXDCCAkSgAwIBAgIUdjhrFcVUVnrr0dzbWUovkn5wA8QwDQYJKoZIhvcNAQEL
...
Y2FsIFNvZnR3YXJlMB4XDTI2MDgyMDE3MDk0MFoXDTI3MDgyMTE3MDk0MFowaDFC
...

-----END CERTIFICATE-----
-----BEGIN SIGNATURE-----

-----END SIGNATURE-----
