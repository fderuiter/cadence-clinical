...
// Inject dynamic decoupled signature store if available, fallback to Pinia useSignatureStore
const signatureStore = inject("signatureStore", null) || useSignatureStore();
