        ...
        >
          <template v-for="field in store.ecrfFields" :key="field.id">
            ...
            >
              ...
              <QueryPanel
                :field="field"
                :active-query-panels="activeQueryPanels"
                :query-inputs="queryInputs"
                :query-responses="queryResponses"
                :store="store"
                @toggle-query-panel="toggleQueryPanel"
                @create-query="createQuery"
                @respond-query="respondQuery"
                @close-query="closeQuery"
                @reopen-query="reopenQuery"
                @update-query-input="
                  (fieldId, val) => (queryInputs[fieldId] = val)
                "
                @update-query-response="
                  (fieldId, val) => (queryResponses[fieldId] = val)
                "
              />
            </div>
