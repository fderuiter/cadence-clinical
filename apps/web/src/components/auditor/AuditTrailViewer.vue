      ...
      >
        ...
        <tbody>
          <tr v-if="events.length === 0">
            <td
              colspan="5"
              style="padding: 24px; text-align: center; color: var(--text-muted); font-style: italic;"
            >
          ...
          >
            ...
            <td style="padding: 12px 16px;">
              <div
                v-if="event.reason_for_change || event.reasonForChange"
                class="part11-reason"
                style="padding: 6px 8px; background: rgba(0, 123, 255, 0.05); border-left: 3px solid var(--accent); border-radius: 2px; font-size: 11px; margin-bottom: 6px; color: var(--text);"
              >
                <strong>Reason:</strong> {{ event.reason_for_change || event.reasonForChange }}
              </div>
              <div
                v-if="event.version_index !== undefined || event.versionIndex !== undefined"
