...
from apps.etmf.adapters.models import DocumentExpirationAlertState, TMFDocument
...
async def dispatch_undispatched_alerts(session_maker: Any) -> None:
    ...
    """
    from apps.etmf.adapters.database import current_session
    from apps.etmf.adapters.notifications_client import publish_expiration_notification
