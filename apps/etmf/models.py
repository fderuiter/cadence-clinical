...
class TMFDocument(Base):
    ...
    reason_for_change: Mapped[Optional[str]] = mapped_column(String(1000), nullable=True)
    ...
    protocol_version_status: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
