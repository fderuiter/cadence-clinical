...
revision: str = "6f491802984e"  # pragma: allowlist secret
down_revision: str | None = "f7ebdb42c09c"  # pragma: allowlist secret
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "retry_eligible", sa.Boolean(), nullable=False, server_default="true"
        ),
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_integration_outbox_correlation_id"), table_name="integration_outbox"
    )
