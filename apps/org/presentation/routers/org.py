...
router = APIRouter(tags=["Organization Directory"])
...
@router.get("/api/v1/org/organizations", response_model=list[OrganizationResponse])
...
@router.get("/api/v1/org/organizations/{id}", response_model=OrganizationResponse)
...
@router.put("/api/v1/org/organizations/{id}", response_model=OrganizationResponse)
...
@router.post(
    "/api/v1/org/delegations", response_model=DelegationResponse, status_code=201
)
...
@router.post("/api/v1/org/delegations/{id}/sign-off", response_model=DelegationResponse)
...
@router.post("/api/v1/org/delegations/{id}/revoke", response_model=DelegationResponse)
...
@router.get("/api/v1/org/delegations", response_model=list[DelegationResponse])
...
@router.get("/api/v1/org/delegations/{id}", response_model=DelegationResponse)
...
@router.get("/api/v1/org/audit-logs", response_model=list[OrgAuditLogResponse])
...
@router.post("/api/v1/org/sites", response_model=SiteResponse, status_code=201)
...
@router.get("/api/v1/org/sites", response_model=list[SiteResponse])
...
@router.get("/api/v1/org/sites/{id}", response_model=SiteResponse)
async def get_site(
    request: Request,
    id: str,
    version_index: int | None = Query(
...
@router.put("/api/v1/org/sites/{id}", response_model=SiteResponse)
...
@router.get("/api/v1/org/sites/{id}/history", response_model=list[SiteResponse])
...
@router.post("/api/v1/org/personnel", response_model=PersonnelResponse, status_code=201)
...
@router.get("/api/v1/org/personnel", response_model=list[PersonnelResponse])
...
@router.get("/api/v1/org/personnel/{id}", response_model=PersonnelResponse)
...
@router.put("/api/v1/org/personnel/{id}", response_model=PersonnelResponse)
...
@router.get(
    "/api/v1/org/personnel/{id}/history", response_model=list[PersonnelResponse]
)
...
@router.get(
    "/api/v1/org/assignments/resolve", response_model=AssignmentResolutionResponse
)
...
@router.get("/api/v1/org/training-logs", response_model=list[TrainingLogResponse])
...
@router.get("/api/v1/org/training-logs/{id}", response_model=TrainingLogResponse)
...
@router.put("/api/v1/org/training-logs/{id}", response_model=TrainingLogResponse)
...
@router.post("/api/v1/org/training-logs/{id}/sign", response_model=TrainingLogResponse)
