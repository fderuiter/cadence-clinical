...
async def validation_exception_handler(request: Request, exc: RequestValidationError):
    ...
    problem = ProblemDetails(
        type="https://api.cadence-clinical.com/errors/validation-failed",  # deid: ignore
...
async def study_differences(
    ...
    """
    base_url = os.getenv("STUDY_REGISTRY_URL", "http://localhost:8000")  # deid: ignore
...
async def validate_usdm_endpoint(
    ...
    if not report.validity:
        ...
        problem = ProblemDetails(
            type="https://api.cadence-clinical.com/errors/usdm-validation-failed",  # deid: ignore
...
async def get_concepts(
    ...
    return ConceptListResponse(
        ...
        data=[
            ConceptDetail(
                id="bc_sys_bp_001",
                concept_code="271649006",  # deid: ignore
...
async def update_concept(
    ...
    return ConceptDetail(
        id=id,
        concept_code="364075005",  # deid: ignore
        terminology="SNOMED-CT",
        display_name=payload.display_name,
        definition=payload.definition,
        cdash_mapping=payload.cdash_mapping,
