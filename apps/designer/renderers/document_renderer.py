"""PDF and DOCX document rendering pipeline for clinical protocol synopsis documents.

Transforms rendered protocol view models into publication-quality PDF and Word (.docx)
documents complying with TransCelerate CPT and ICH M11 standards.
