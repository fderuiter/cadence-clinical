...
SUPPORTED_LANGUAGE_CODES: Set[str] = {
    "en", "es", "fr", "de", "it", "pt", "zh", "ja", "ko", "nl", "pl", "ru",
    "sv", "tr", "ar", "hi", "da", "fi", "no", "he", "id", "ms", "th", "vi",
    "el", "hu", "cs", "ro", "sk", "bg", "uk", "hr", "sr", "sl", "et", "lv", "lt"
}
...
def validate_language_code(code: str) -> str:
    ...
    if normalized not in SUPPORTED_LANGUAGE_CODES:
        raise ValueError(f"Language code '{code}' is not supported. Must be a valid ISO 639-1 code.")
