...
def seed_clinical_data(
    ...
    scenario: str = typer.Option(
        "oncology-phase3", "--scenario", "-s", help="Named clinical scenario"
    ),
) -> None:
    ...
    # 1. Seed SQLite databases with foundational test data
    # eConsent
    ...
    with sqlite3.connect(safety_db) as conn:
        ...
        conn.commit()
    seeded_entities["summary"]["safety_sae_cases"] = 1
