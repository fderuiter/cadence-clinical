...
from packages.deidentification.transforms import RedactionRecordItem
...
class RedactionManifest(BaseModel):
    ...
    source_version_index: Optional[int] = Field(
        None, description="Optional version index of the source document"
    )
    target_version_index: Optional[int] = Field(
        None, description="Optional version index of the target document"
    )
...
def build_redaction_manifest(
    ...
    source_version: str,
    target_version: str,
    source_version_index: Optional[int] = None,
    ...
    Args:
        ...
        source_version_index (Optional[int]): Source version index.
        target_version_index (Optional[int]): Target version index.
