...
* **Format:** Create a new markdown document inside `docs/adr/` using the format `YYYY-MM-DD-short-title.md` (e.g., `docs/adr/2026-07-27-dynamic-msw-contract-mocking.md`).
