...
def test_part11_manifestation_mapping_and_validation(crypto_material):
    ...
    expected_hash = "abcde1234567890f" * 4  # pragma: allowlist secret
    assert manifest.signature_hash_sha256 == expected_hash
    ...
    legacy_hash = "12345abcde" * 6 + "1234"  # pragma: allowlist secret
    ...
    assert legacy_manifest.sha256_hash == legacy_hash
    ...
    assert legacy_manifest.signature_hash_sha256 == legacy_hash
