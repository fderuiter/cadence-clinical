...
def test_part11_manifestation_mapping_and_validation(crypto_material):
    ...
    assert (
        manifest.signature_hash_sha256
        == "abcde1234567890f" * 4  # pragma: allowlist secret
    )
    ...
    assert (
        legacy_manifest.sha256_hash
        == "12345abcde" * 6 + "1234"  # pragma: allowlist secret
    )
    ...
    assert (
        legacy_manifest.signature_hash_sha256
        == "12345abcde" * 6 + "1234"  # pragma: allowlist secret
    )
