...
async def test_impact_analysis_meddra_and_whodrug_lifecycle():
    ...
    async with httpx.AsyncClient(
        ...
        async with db_manager.get_session_maker()() as session:
            ...
            m1_ledger = next(ledg for ledg in ledgers if ledg.assignment_id == "A-M1")
            ...
            m2_ledger = next(ledg for ledg in ledgers if ledg.assignment_id == "A-M2")
            ...
            m3_ledger = next(ledg for ledg in ledgers if ledg.assignment_id == "A-M3")
