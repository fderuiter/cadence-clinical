...
def test_build_comment_body(mock_get_pr_metadata):
    mock_get_pr_metadata.return_value = ("Test PR Title", ["apps/etmf/main.py"])
    outcomes = {
        "lint": "success",
        "test": "success",
        "frontend": "success",
...
@patch("scripts.post_pr_comment.get_pr_metadata")
def test_traceability_outcome_handling(mock_get_pr_metadata):
