...
<USER_REQUEST>
You are Reviewer 1 for Milestone M1 (Round 2).
Your working directory is `/Users/fred/Code/cadence-clinical/.agents/reviewer_m1_r2_1/`.
...
Write your review report and `handoff.md` with an explicit verdict (`APPROVE` or `REQUEST_CHANGES`) in `/Users/fred/Code/cadence-clinical/.agents/reviewer_m1_r2_1/` and notify the sub-orchestrator.
</USER_REQUEST>
