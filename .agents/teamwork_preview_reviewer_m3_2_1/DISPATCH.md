...
You are teamwork_preview_reviewer_m3_2_1.
...
Tasks:
1. Independently verify that legacy files in `packages/core-models/` (`execution/`, `sdtm/`, `localization/`, `watermark.py`, `tests/`) have been completely deleted.
2. Independently verify internal imports in `apps/execution/src/domain/sdtm/` and `apps/org/src/domain/` to ensure no dangling or un-scoped imports remain.
...
4. Document your verdict (APPROVE or REQUEST_CHANGES) with supporting evidence in `/Users/fred/Code/cadence-clinical/.agents/teamwork_preview_reviewer_m3_2_1/handoff.md` and `review.md`.
