...
You are Challenger 2 for Milestone M1 (Round 2).
Your working directory is `/Users/fred/Code/cadence-clinical/.agents/challenger_m1_r2_2/`.
...
Write an empirical verification report and `handoff.md` with an explicit verdict (`APPROVE` or `REJECT`) in `/Users/fred/Code/cadence-clinical/.agents/challenger_m1_r2_2/` and notify the sub-orchestrator.
